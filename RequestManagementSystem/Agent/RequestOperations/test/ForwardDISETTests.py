...
# # SUT
from DIRAC.RequestManagementSystem.Agent.RequestOperations.ForwardDISET import (
    ForwardDISET,
)
...
class ForwardDISETTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.op = Operation(
            {"Type": "ForwardDISET", "Arguments": DEncode.encode(self.hiArgs)}
        )
        self.req += self.op
    ...
    def testCase(self):
        ...
        try:
            ...
            pass
        self.assertEqual(
            isinstance(forwardDISET, ForwardDISET), True, "construction error"
        )

        forwardDISET.setOperation(self.op)
        self.assertEqual(
            isinstance(forwardDISET.operation, Operation), True, "setOperation error"
        )
