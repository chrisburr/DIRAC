...
class RequestValidatorTests(unittest.TestCase):
    ...
    def testValidator(self):
        ...
        self.assertEqual(
            ret,
            {
                "Message": "Operation #0 in request 'test_request' hasn't got Type set",
                "OK": False,
            },
        )
        ...
        self.assertEqual(
            ret,
            {"Message": "Request 'test_request' is missing OwnerDN value", "OK": False},
        )
        ...
        self.assertEqual(
            ret,
            {
                "Message": "Request 'test_request' is missing OwnerGroup value",
                "OK": False,
            },
        )
