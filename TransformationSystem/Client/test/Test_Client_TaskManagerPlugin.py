...
class opsHelperFakeUser2(object):
    ...
    def getOptionsDict(self, foo=""):
        return {
            "OK": True,
            "Value": {"Paris": "IN2P3", "CERN": "CERN", "IN2P3": "IN2P3"},
        }
...
class opsHelperFakeMerge(object):
    ...
    def getOptionsDict(self, foo=""):
        return {
            "OK": False,
            "Message": "JobTypeMapping/MCSimulation/Allow in Operations does not exist",
        }
...
def getSitesFake():
    return S_OK(
        ["Ferrara", "Bologna", "Paris", "CSCS", "PAK", "CERN", "IN2P3", "Hospital"]
    )
...
if __name__ == "__main__":
    ...
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(TaskManagerPluginSuccess)
    )
