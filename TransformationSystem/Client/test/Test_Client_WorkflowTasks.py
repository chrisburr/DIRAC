...
taskDictSimple = {
    1: {"TransformationID": 1, "Site": "MySite"},
...
expectedBulkSimple = {
    ...
    "Value": {
        "BulkJobObject": "",
        1: {"TransformationID": 1, "InputData": ["a1", "a2", "a3"], "JobType": "User"},
    },
}
...
def test_prepareTranformationTasks(
    taskDictionary, bulkSubmissionFlag, result, expectedRes
):
...
def test__handleDestination(mocker, paramsDict, expected):
    mocker.patch(
        "DIRAC.TransformationSystem.Client.TaskManagerPlugin.getSitesForSE",
        side_effect=ourgetSitesForSE,
    )
