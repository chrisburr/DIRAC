...
class TransformationSuccess(ClientsTestCase):
    def test_setGet(self):
        ...
        transBody = [
            [
                u"ReplicateAndRegister",
                {u"SourceSE": u"FOO-SRM", u"TargetSE": u"BAR-SRM"},
            ],
...
if __name__ == "__main__":
    ...
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(PluginUtilitiesSuccess)
    )
    suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(RequestTasksSuccess))
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(TransformationSuccess)
    )
