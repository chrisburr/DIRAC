...
GET_VOMS = (
    "DIRAC.TransformationSystem.Utilities.ReplicationCLIParameters.getVOMSVOForGroup"
)
...
class TestMoving(unittest.TestCase):
    ...
    def test_createRepl_Broadcast(self):
        ...
        with patch(
            trmodule + ".getTransformation", new=Mock(return_value=S_OK({}))
        ), patch(trmodule + ".addTransformation", new=Mock(return_value=S_OK())), patch(
            trmodule + "._Transformation__setSE", new=Mock(return_value=S_OK())
        ):
            ret = createDataTransformation(
                "Moving", tSE, sSE, "prodID", prodID, enable=True
            )
    ...
    def test_createRepl_Dry(self):
        ...
        with patch(
            ...
            ret = createDataTransformation(
                "Moving", tSE, sSE, "prodID", prodID, enable=False, extraData={}
            )
        self.assertTrue(ret["OK"], ret.get("Message", ""))
    ...
    def test_createRepl_2(self):
        ...
        with patch(
            ...
            ret = createDataTransformation(
                "Moving", tSE, sSE, "prodID", prodID, extraname="extraName", enable=True
            )
        self.assertTrue(ret["OK"], ret.get("Message", ""))
    ...
    def test_createRepl_BadFlavour(self):
        ...
        with patch(
            ...
            ret = createDataTransformation(
                "Smelly", tSE, sSE, "prodID", prodID, extraname="extraName", enable=True
            )
    ...
    def test_createRepl_SEFail_1(self):
        ...
        with patch(
            ...
            new=Mock(side_effect=(S_OK(), S_ERROR())),
        ):
            ret = createDataTransformation(
                "Moving", tSE, sSE, "prodID", prodID, enable=True
            )
    ...
    def test_createRepl_addTrafoFail_(self):
        ...
        with patch(
            ...
            new=Mock(return_value=S_ERROR("Cannot add Trafo")),
        ), patch(
            trmodule + "._Transformation__setSE", new=Mock(return_value=S_OK())
        ):
            ret = createDataTransformation(
    ...
    def test_createRepl_createTrafoFail_(self):
        ...
        with patch(
            ...
            trmodule + ".addTransformation",
            new=Mock(return_value=S_ERROR("Failed to add IMQ")),
        ), patch(
            trmodule + "._Transformation__setSE", new=Mock(return_value=S_OK())
        ):
            ret = createDataTransformation(
...
class TestParams(unittest.TestCase):
    ...
    def test_checkSettings_FailArgumentSize(self):
        ...
        self.assertTrue(
            any(
                "ERROR: Wrong number of arguments" in msg
                for msg in self.params.errorMessages
            )
        )
    ...
    def test_FailProxy(self):
        ...
        self.assertFalse(ret["OK"], str(ret))
        self.assertTrue(
            any("ERROR: No Proxy" in msg for msg in self.params.errorMessages),
    ...
    def test_FailProxy2(self):
        ...
        self.assertFalse(ret["OK"], str(ret))
        self.assertTrue(
            any("ERROR: ProxyGroup" in msg for msg in self.params.errorMessages),
            str(self.params.errorMessages),
        )
