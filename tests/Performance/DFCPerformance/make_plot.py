...
parser.add_option(
    ...
    "--plot",
    dest="plot",
    help="Destination of the plot file (default: plot.png)",
    default="plot.png",
)
parser.add_option(
    "-d",
    "--hist",
    dest="hist",
    help="Destination of the histogram file (default: hist.png)",
    default="hist.png",
)
parser.add_option(
    "-t", "--title", dest="title", help="Title of the plots", type="string", default=""
)
parser.add_option(
    "-b",
    "--bin",
    ...
    default=10,
    type="int",
    help="Size of the bin in sec (default: 10)",
)
parser.add_option(
    "-m",
    "--no-max",
