...
class LHCbTransformationClientChain(TestClientTransformationTestCase):
    ...
    def test_LHCbOnly(self):
        ...
        res = self.transClient.addTransformation(
            ...
            "Manual",
            "",
            bkQuery={"DataTakingConditions": "DataTakingConditions", "EventType": 12345},
        )
        self.assertTrue(res["OK"])
        transID = res["Value"]
        ...
        self.assertEqual(
            res["Value"],
            {"StartRun": 1, "EndRun": 10, "EventType": 12345, "DataTakingConditions": "DataTakingConditions"},
        )
