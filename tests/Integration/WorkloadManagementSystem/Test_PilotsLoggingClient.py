...
from DIRAC.WorkloadManagementSystem.Client.PilotsLoggingClient import (
    PilotsLoggingClient,
)
...
class PilotsLogging(TestPilotsLogging):
    def test_PilotsLoggingAddGetDelete(self):
        ...
        self.assertTrue(resp["OK"], "Failed to add PilotsLogging")
        resp = self.pilotsLoggingClient.getPilotsLogging(
            "11111111-1111-1111-1111-111111111111"
        )
        ...
        self.assertEqual(
            resp["Value"],
            [test_sample, test_sample2],
            "Wrong data comes out of Service",
        )
    ...
    def test_PilotsLoggingDeleteList(self):
        ...
        self.assertTrue(resp["OK"], "Failed to get PilotsLogging")
        self.assertEqual(
            resp["Value"], [test_sample1], "Wrong data comes out of Service"
        )
        resp = self.pilotsLoggingClient.getPilotsLogging(
            "22222222-2222-2222-2222-222222222222"
        )
        self.assertTrue(resp["OK"], "Failed to get PilotsLogging")
        self.assertEqual(
            resp["Value"], [test_sample2], "Wrong data comes out of Service"
        )
        resp = self.pilotsLoggingClient.deletePilotsLogging(
            [
                "11111111-1111-1111-1111-111111111111",
