...
class ComponentMonitoringClientChain(TestClientComponentMonitoring):
    ...
    def testComponents(self):
        ...
        self.client.addComponent(
            {"DIRACSystem": "Test", "DIRACModule": "TestModule1", "Type": "TestingFeature1"}
        )
        self.client.addComponent(
            {"DIRACSystem": "Test", "DIRACModule": "TestModule2", "Type": "TestingFeature1"}
        )
        self.client.addComponent(
            {"DIRACSystem": "Test", "DIRACModule": "TestModule1", "Type": "TestingFeature2"}
        )
        ...
        result = self.client.getComponents(
            {"DIRACSystem": "Test", "DIRACModule": "TestModule1"}, False, False
        )
