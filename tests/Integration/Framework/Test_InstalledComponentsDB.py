...
class ComponentMonitoringClientChain(TestClientComponentMonitoring):
    ...
    def testComponents(self):
        ...
        result = self.client.addComponent(
            {"System": "Test", "Module": "TestModule", "Type": "TestingFeature"}
        )
        ...
        result = self.client.getComponents(
            {"System": "Test", "Module": "NewTestModule", "Type": "TestingFeature"},
            False,
            False,
        )
        ...
        # Multiple removal
        self.client.addComponent(
            {"System": "Test", "Module": "TestModule1", "Type": "TestingFeature1"}
        )
        self.client.addComponent(
            {"System": "Test", "Module": "TestModule2", "Type": "TestingFeature1"}
        )
        self.client.addComponent(
            {"System": "Test", "Module": "TestModule1", "Type": "TestingFeature2"}
        )
        ...
        result = self.client.getComponents(
            {"System": "Test", "Module": "TestModule1"}, False, False
        )
    ...
    def testHosts(self):
        ...
        result = self.client.getHosts(
            {"HostName": "TestHost", "CPU": "TestCPU"}, False, False
        )

        self.assertTrue(result["OK"] and len(result["Value"]) > 0)

        # Update the fields of the created host
        result = self.client.updateHosts(
            {"HostName": "TestHost", "CPU": "TestCPU"}, {"HostName": "StillATestHost"}
        )
        ...
        result = self.client.getHosts(
            {"HostName": "StillATestHost", "CPU": "TestCPU"}, False, False
        )

        self.assertTrue(result["OK"] and len(result["Value"]) > 0)

        # Remove the Host
        result = self.client.removeHosts(
            {"HostName": "StillATestHost", "CPU": "TestCPU"}
        )
        ...
        result = self.client.getHosts(
            {"HostName": "TestHost", "CPU": "TestCPU2"}, False, False
        )

        self.assertTrue(result["OK"] and len(result["Value"]) >= 1)

        result = self.client.getHosts(
            {"HostName": "TestHost", "CPU": "TestCPU1"}, False, False
        )
    ...
    def testInstallations(self):
        ...
        result = self.client.getInstallations(
            {"Instance": ["MultipleRemovalInstall1", "MultipleRemovalInstall3"]},
            {},
            {},
            False,
        )
        ...
        self.client.removeInstallations({}, {"Module": "UnexistentModule"}, {})

        result = self.client.getInstallations(
            {}, {"Module": "UnexistentModule2"}, {}, False
        )

        self.assertTrue(result["OK"] and len(result["Value"]) >= 1)

        result = self.client.getInstallations(
            {}, {"Module": "UnexistentModule"}, {}, False
        )

        self.assertTrue(result["OK"] and len(result["Value"]) <= 0)

        self.client.removeInstallations({}, {"Module": "UnexistentModule2"}, {})
...
if __name__ == "__main__":
    ...
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(ComponentMonitoringClientChain)
    )
