...
def test_xmltojson():
    ...
    assert JSON1 == {
        "Counters": {
            ...
            "CheckRichSegments/Diff.": {
                "Traj. Momenta": {"y": 3, "x": 1, "z": -8},
                "Traj. Point": {"y": 0, "x": 0, "z": 0},
            },
    ...
    assert JSON2 == {
        "Counters": {
            ...
            "UnpackOTHits": {"UnPackedData": 253748},
            "MCTTHitPacker": {"PackedData": 73624},
            "MCRichHitPacker": {"PackedData": 775606},
            "Generation.SignalPlain.TightCut": {
                "accept_events": 1,
                "selected marked": 203,
                "Efficiency for  [pi+]cc": 47,
                "no cuts found for gamma": 38,
                "Efficiency for  [D0]cc": 1,
                "no cuts found for pi0": 19,
                "accept_particles": 1,
            },
            "UnpackRichTracks": {"UnPackedData": 32641},  # nopep8
            "SignalSim.SignalSimMemory": {"Total Memory/MB": 177999, "Delta Memory/MB": 69},
            "CounterSummarySvc": {"handled": 201},
            "MCRichOpPhotPacker": {"PackedData": 775504},
            "CheckRichOpPhot/Diff.": {
                "Energy": 0,
                "Sec. Mirr.": {"y": 0, "x": 0, "z": 0},
                "HPD In. Point": {"y": 0, "x": 0, "z": 0},
                "Parent Momentum": {"y": 70, "x": -39, "z": -115},
                "Prim. Mirr.": {"y": 0, "x": 0, "z": 0},
                "Cherenkov": {"Theta": 0, "Phi": 0},
                "Emission Point": {"y": 0, "x": 0, "z": 0},
                "HPD QW Point": {"y": 0, "x": 0, "z": 0},
            },
            "UnpackPrsHits": {"UnPackedData": 567900},
            "UnpackPuVetoHits": {"UnPackedData": 9800},
            "MCSpdHitPacker": {"PackedData": 284467},
            "UnpackITHits": {"UnPackedData": 86436},
            "MCPrsHitPacker": {"PackedData": 567900},
            "UnpackMuonHits": {"UnPackedData": 78779},
            "UnpackEcalHits": {"UnPackedData": 734334},
            "MainEventGaussSim.MainEventGaussSimMemory": {"Total Memory/MB": 177815, "Delta Memory/MB": 69},
            "MCRichTrackPacker": {"PackedData": 32641},
            "UnpackRichHits": {"UnPackedData": 775606},
            "CheckVeloHits/Diff.": {
                "Entry Point": {"y": 0, "x": 0, "z": 0},
                "Energy": 0,
                "TOF": 0,
            ...
            "UnpackVeloHits": {"UnPackedData": 244708},
            "UnpackRichOpPhot": {"UnPackedData": 775504},
            "CheckRichSegments/Diff.": {
                "Traj. Momenta": {"y": -20, "x": 16, "z": -12},
                "Traj. Point": {"y": 0, "x": 0, "z": 0},
            },
            "UnpackSpdHits": {"UnPackedData": 284467},
            "CheckOTHits/Diff.": {
                "Entry Point": {"y": 0, "x": 0, "z": 0},
                "Energy": 0,
                "TOF": 0,
            ...
            "MCOTHitPacker": {"PackedData": 253748},
            "UnpackTTHits": {"UnPackedData": 73624},
            "CheckTTHits/Diff.": {
                "Entry Point": {"y": 0, "x": 0, "z": 0},
                "Energy": 0,
                "TOF": 0,
            ...
            "OTHitMonitor": {"betaGamma": 338754733, "DeltaRay": 16893, "numberHits": 253748},
            "GenerationSignal.SignalPlain.TightCut": {  # nopep8
                "accept_events": 100,
                "selected marked": 1988,
                "Efficiency for  [pi+]cc": 405,
                "no cuts found for gamma": 270,
                "Efficiency for  [D0]cc": 100,
                "no cuts found for pi0": 135,
                "accept_particles": 100,
            },
            "CheckPuVetoHits/Diff.": {  # nopep8
                "Entry Point": {"y": 0, "x": 0, "z": 0},
                "Energy": 0,
                "TOF": 0,
                "Parent |P|": 3,
            ...
            "MCEcalHitPacker": {"PackedData": 734334},
            "MCRichSegmentPacker": {"PackedData": 38582},
            "MCPuVetoHitPacker": {"PackedData": 9800},
            "GaussGen.GaussGenMemory": {"Total Memory/MB": 177734, "Delta Memory/MB": 69},
            "CheckMuonHits/Diff.": {
                "Entry Point": {"y": 0, "x": 0, "z": 0},
                "Energy": 0,
                "TOF": 0,
            ...
            "UnpackHcalHits": {"UnPackedData": 130737},
            "UnpackRichSegments": {"UnPackedData": 38582},
            "MCMuonHitPacker": {"PackedData": 78779},
            "TTHitMonitor": {"betaGamma": 72641099, "DeltaRay": 10184, "numberHits": 73624},
            "MCHcalHitPacker": {"PackedData": 130737},
            "SignalGen.SignalGenMemory": {"Total Memory/MB": 177999, "Delta Memory/MB": 69},
        }
    }
