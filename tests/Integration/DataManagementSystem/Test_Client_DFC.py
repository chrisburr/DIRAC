...
class FileCase(DFCTestCase):
    def test_fileOperations(self):
        ...
        self.assertTrue(
            filecmp.cmp(expectedDumpFn, actualDumpFn),
            "Did not get the expected SE Dump",
        )
...
class ReplicaCase(DFCTestCase):
    def test_replicaOperations(self):
        ...
        # Adding new replica
        result = self.dfc.addReplica(
            {testFile: {"PFN": "testFilePFN", "SE": "otherSE"}}
        )
        self.assertTrue(
        ...
        result = self.dfc.addReplica(
            {nonExistingFile: {"PFN": "IdontexistPFN", "SE": "otherSE"}}
        )
        self.assertTrue(
            result["OK"],
        ...
        result = self.dfc.setReplicaStatus(
            {testFile: {"Status": "Trash", "SE": "otherSE"}}
        )
        self.assertTrue(
            result["OK"],
        ...
        result = self.dfc.setReplicaStatus(
            {testFile: {"Status": "randomStatus", "SE": "otherSE"}}
        )
        self.assertTrue(
            result["OK"],
        ...
        result = self.dfc.setReplicaStatus(
            {testFile: {"Status": "Trash", "SE": "nonExistingSe"}}
        )
        self.assertTrue(
            result["OK"],
...
class DirectoryCase(DFCTestCase):
    def test_directoryOperations(self):
        ...
        self.assertTrue(
            result["Value"]["Successful"][testDir],
            "removeDirectory : %s should be in True %s" % (testDir, result),
        )
        self.assertTrue(
            nonExistingDir in result["Value"]["Successful"],
