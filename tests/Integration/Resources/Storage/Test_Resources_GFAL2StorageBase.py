...
class basicTest(unittest.TestCase):
    ...
    def setUp(self, pluginToTest):
        ...
        self.assertTrue(
            self.readSE == specSE or self.writeSE == specSE, "Using only generic SE does not make sense!!"
        )
...
@unittest.skipIf(
    "SRM2" not in AVAILABLE_PLUGINS, "StorageElement %s does not have plugin SRM2 defined" % STORAGE_NAME
)
