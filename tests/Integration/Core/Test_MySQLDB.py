...
@pytest.mark.parametrize(
    "name, fields, values, table, expected",
...
def test_getDistinctAttributeValues(
    name, fields, requiredFields, values, table, cond, expected
):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            genVal1(),
            name,
            {"outFields": reqFields, "condDict": cond10},
            10,
            True,
        ),
        ...
        (
            ...
            genVal2(),
            name,
            {"older": "UTC_TIMESTAMP()", "timeStamp": "Time"},
            2,
            True,
        ),
        (
            ...
            genVal2(),
            name,
            {"newer": "UTC_TIMESTAMP()", "timeStamp": "Time"},
            0,
            True,
        ),
        (
            ...
            genVal2(),
            name,
            {"older": Time.toString, "timeStamp": "Time"},
            2,
            True,
        ),
        (
            ...
            genVal2(),
            name,
            {"newer": Time.toString, "timeStamp": "Time"},
            0,
            True,
        ),
    ],
