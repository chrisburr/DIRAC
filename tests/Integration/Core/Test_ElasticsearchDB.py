    ...
    def __init__(self, *args, **kwargs):
        ...
        self.data = [
            {
                ...
                "quantity": 1,
                "Product": "a",
                "timestamp": "2015-02-09 09:00:00.0",
            },
            {
                "Color": "red",
                "quantity": 1,
                "Product": "b",
                "timestamp": "2015-02-09 16:15:00.0",
            },
            {
                "Color": "red",
                "quantity": 1,
                "Product": "b",
                "timestamp": "2015-02-09 16:30:00.0",
            },
            {
                "Color": "red",
                "quantity": 1,
            ...
            },
            {
                ...
                "quantity": 1,
                "Product": "a",
                "timestamp": "2015-02-09 09:15:00.0",
            },
            {
                "Color": "red",
                "quantity": 2,
        ...
        self.moreData = [
            ...
            },
            {
                ...
                "quantity": 1,
                "Product": "c",
                "timestamp": "2015-02-09 09:30:00.0",
            },
            {
                "Color": "red",
                "quantity": 1,
                "Product": "d",
                "timestamp": "2015-02-09 10:00:00.0",
            },
            {
                "Color": "red",
                "quantity": 1,
                "Product": "e",
                "timestamp": "2015-02-09 10:15:00.0",
            },
            {
                "Color": "red",
                "quantity": 1,
                "Product": "f",
                "timestamp": "2015-02-09 10:30:00.0",
            },
            {
                "Color": "red",
                "quantity": 1,
                "Product": "g",
                "timestamp": "2015-02-09 10:45:00.0",
            },
            {
                "Color": "red",
                "quantity": 1,
                "Product": "h",
                "timestamp": "2015-02-09 11:00:00.0",
            },
            {
                "Color": "red",
                "quantity": 1,
                "Product": "i",
                "timestamp": "2015-02-09 11:15:00.0",
            },
            {
                "Color": "red",
                "quantity": 1,
                "Product": "l",
                "timestamp": "2015-02-09 11:30:00.0",
            },
        ]
...
class ElasticBulkCreateChain(ElasticTestCase):
    ...
    def test_bulkindexMonthly(self):
        ...
        result = self.elasticSearchDB.bulk_index(
            indexPrefix="integrationtestmontly", data=self.data, period="month"
        )
        self.assertTrue(result["OK"])
        self.assertEqual(result["Value"], 10)
        time.sleep(5)
...
class ElasticCreateChain(ElasticTestCase):
    ...
    def test_wrongdataindex(self):
        ...
        result = self.elasticSearchDB.index(
            index_name,
            {"Color": "red", "quantity": 1, "Product": "a", "timestamp": 1458226213},
        )
        self.assertTrue(result["OK"])
        result = self.elasticSearchDB.index(
            index_name,
...
class ElasticTestChain(ElasticTestCase):
    ...
    def test_getDocTypes(self):
        ...
        if "_doc" in result["Value"]:
            self.assertEqual(
                list(result["Value"]["_doc"]["properties"]),
                [u"Color", u"timestamp", u"Product", u"quantity"],
            )
        else:
            self.assertEqual(
                list(result["Value"]["properties"]),
                [u"Color", u"timestamp", u"Product", u"quantity"],
            )
    ...
    def test_Search(self):
        ...
        self.assertEqual(
            dir(result.hits[0]),
            [u"Color", u"Product", "meta", u"quantity", u"timestamp"],
        )

        q = self.elasticSearchDB._Q(
            "range", timestamp={"lte": 1423501337292, "gte": 1423497057518}
        )
        s = self.elasticSearchDB._Search(self.index_name)
        ...
        q = self.elasticSearchDB._Q(
            "range", timestamp={"lte": 1423631917911, "gte": 1423399451544}
        )
        s = self.elasticSearchDB._Search(self.index_name)
        s = s.filter("bool", must=q)
        query = s.to_dict()
...
if __name__ == "__main__":
    ...
    testSuite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(ElasticCreateChain)
    )
    testSuite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(ElasticBulkCreateChain)
    )
    testSuite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(ElasticTestChain)
    )
    testSuite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(ElasticDeleteChain)
    )
