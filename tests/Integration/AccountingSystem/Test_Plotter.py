...
class DataStoragePlotterUnitTest(PlotterTestCase):
    def test_plotCatalogSpace(self):
        ...
        plotInfo = {
            "graphDataDict": {"Full stream": {1355616000: 4.9003546130956819, 1355702400: 4.9050379437065059}},
            "data": {"Full stream": {1355616000: 4900354613.0956821, 1355702400: 4905037943.7065058}},
            "unit": "PB",
            "granularity": 86400,
        }
