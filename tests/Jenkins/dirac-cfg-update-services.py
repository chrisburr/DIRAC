...
csAPI.setOption(
    "Systems/DataManagement/Production/Services/FileCatalog/UniqueGUID", True
)

csAPI.setOption(
    "Systems/DataManagement/Production/Services/MultiVOFileCatalog/DirectoryManager",
    "DirectoryClosure",
)
csAPI.setOption(
    "Systems/DataManagement/Production/Services/MultiVOFileCatalog/FileManager",
    "FileManagerPs",
)
csAPI.setOption(
...
csAPI.setOption(
    "Systems/DataManagement/Production/Services/MultiVOFileCatalog/UniqueGUID", True
)
