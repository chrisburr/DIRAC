...
csAPI.setOption(
    "Systems/DataManagement/Production/Services/FileCatalog/SecurityManager", "VOMSSecurityManager"
)
csAPI.setOption("Systems/DataManagement/Production/Services/FileCatalog/UniqueGUID", True)

csAPI.setOption(
    "Systems/DataManagement/Production/Services/MultiVOFileCatalog/DirectoryManager", "DirectoryClosure"
)
csAPI.setOption("Systems/DataManagement/Production/Services/MultiVOFileCatalog/FileManager", "FileManagerPs")
csAPI.setOption(
    "Systems/DataManagement/Production/Services/MultiVOFileCatalog/SecurityManager", "NoSecurityManager"
)
