...
csAPI.setOption(
    "Systems/DataManagement/Production/Databases/FileCatalogDB/DBName", "FileCatalogDB"
)
csAPI.setOption(
...
csAPI.setOption(
    "Systems/DataManagement/Production/Databases/MultiVOFileCatalogDB/Host", dbHost
)
csAPI.setOption(
    "Systems/DataManagement/Production/Databases/MultiVOFileCatalogDB/Port", dbPort
)
