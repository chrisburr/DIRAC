...
csAPI.setOption(
    "Systems/WorkloadManagement/Production/Services/SandboxStore/LogLevel", "DEBUG"
)
...
csAPI.setOption(
    "Resources/StorageElements/ProductionSandboxSE/DIP/Path", "%s/sandboxes" % setupName
)
...
csAPI.setOption(
    "Resources/FileCatalogs/TSCatalog/CatalogURL",
...
csAPI.setOption(
    "Resources/FileCatalogs/MultiVOFileCatalog/CatalogURL",
    "DataManagement/MultiVOFileCatalog",
)
...
csAPI.setOption(
    "Resources/Sites/DIRAC/DIRAC.Jenkins.ch/CEs/jenkins.cern.ch/CEType", "Test"
)
csAPI.setOption(
...
csAPI.setOption(
    "Resources/Sites/DIRAC/DIRAC.Jenkins.ch/CEs/jenkins.cern.ch/Queues/jenkins-queue_not_important/SI00",
    "2400",
)
...
csAPI.setOption(
    "Resources/FTSEndpoints/FTS3/JENKINS-FTS3", "https://jenkins-fts3.cern.ch:8446"
)
...
csAPI.setOption(
    "Operations/Defaults/ResourceStatus/Config/FromAddress", "fstagni@cern.ch"
)
csAPI.setOption(
    "Operations/Defaults/ResourceStatus/Config/notificationGroups", "ShiftersGroup"
)
...
res = csAPI.createSection(
    "Operations/Defaults/ResourceStatus/Policies/AlwaysActiveForResource"
)
if not res["OK"]:
    print(res["Message"])
    exit(1)
csAPI.setOption(
    "Operations/Defaults/ResourceStatus/Policies/AlwaysActiveForResource/policyType",
    "AlwaysActive",
)
res = csAPI.createSection(
    "Operations/Defaults/ResourceStatus/Policies/AlwaysActiveForResource/matchParams"
)
if not res["OK"]:
    print(res["Message"])
    exit(1)
csAPI.setOption(
    "Operations/Defaults/ResourceStatus/Policies/AlwaysActiveForResource/matchParams/element",
    "Resource",
)

res = csAPI.createSection(
    "Operations/Defaults/ResourceStatus/Policies/AlwaysBannedForSE1SE2"
)
if not res["OK"]:
    print(res["Message"])
    exit(1)
csAPI.setOption(
    "Operations/Defaults/ResourceStatus/Policies/AlwaysBannedForSE1SE2/policyType",
    "AlwaysBanned",
)
res = csAPI.createSection(
    "Operations/Defaults/ResourceStatus/Policies/AlwaysBannedForSE1SE2/matchParams"
)
if not res["OK"]:
    print(res["Message"])
    exit(1)
csAPI.setOption(
    "Operations/Defaults/ResourceStatus/Policies/AlwaysBannedForSE1SE2/matchParams/name",
    "SE1,SE2",
)

res = csAPI.createSection(
    "Operations/Defaults/ResourceStatus/Policies/AlwaysBannedForSite"
)
if not res["OK"]:
    print(res["Message"])
    exit(1)
res = csAPI.createSection(
    "Operations/Defaults/ResourceStatus/Policies/AlwaysBannedForSite/matchParams"
)
csAPI.setOption(
    "Operations/Defaults/ResourceStatus/Policies/AlwaysBannedForSite/policyType",
    "AlwaysBanned",
)
csAPI.setOption(
    "Operations/Defaults/ResourceStatus/Policies/AlwaysBannedForSite/matchParams/element",
    "Site",
)
...
if not res["OK"]:
    ...
    exit(1)
csAPI.setOption(
    "Operations/Defaults/Services/Catalogs/CatalogList",
...
if not res["OK"]:
    ...
    exit(1)
csAPI.setOption(
    "Operations/Defaults/DataManagement/RegistrationProtocols", "srm,dips,s3"
)
