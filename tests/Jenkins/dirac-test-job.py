...
try:
    inputJ.setInputSandbox(
        [find_all("exe-script-with-input-jenkins.py", rootPath, "tests/System/GridTestSubmission")[0]]
    )
except BaseException:
    inputJ.setInputSandbox(
        [find_all("exe-script-with-input-jenkins.py", os.environ["WORKSPACE"], "tests/System/GridTestSubmission")[0]]
    )
