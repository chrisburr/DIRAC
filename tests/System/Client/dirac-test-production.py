...
prod.setBKParameters(
    configName="outConfigName",
    configVersion="configVersion",
    groupDescriptionOrStepsList="Test",
    conditions="dataTakingConditions",
)
...
stepName = prod.addApplicationStep(stepDict=stepsInProd[0], modulesList=["MergeMDF", "BookkeepingReport"])
...
prod.LHCbJob._addParameter(
    prod.LHCbJob.workflow, "outputSEs", "dict", {"RAW": "CERN-BUFFER"}, "dictionary of output SEs"
)
...
transformation.setOutputDirectories(
    [
        "/lhcb/outConfigName/configVersion/LOG/00000000",
