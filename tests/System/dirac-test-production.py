...
prodJob = Job()
prodJob._addParameter(
    prodJob.workflow, "PRODUCTION_ID", "string", "00012345", "ProductionID"
)
prodJob._addParameter(
    prodJob.workflow, "JOB_ID", "string", "00006789", "ProductionJobID"
)
prodJob._addParameter(
    prodJob.workflow,
    "eventType",
...
prodJob._addParameter(
    prodJob.workflow, "numberOfEvents", "string", "-1", "Number of events requested"
)
prodJob._addParameter(
    prodJob.workflow, "ProcessingType", "JDL", str("Test"), "ProductionGroupOrType"
)
