...
def helloWorld():
    ...
    try:
        J.setInputSandbox(
            [find_all("exe-script.py", rootPath, "DIRAC/tests/Workflow")[0]]
        )
...
def mpJob():
    ...
    try:
        ...
        J.setInputSandbox(
            [find_all("mpTest.py", os.environ["WORKSPACE"], "DIRAC/tests/Utilities")[0]]
        )
...
def jobWithOutput():
    ...
    try:
        ...
        inp2 = [
            find_all("exe-script.py", os.environ["WORKSPACE"], "DIRAC/tests/Workflow")[
                0
            ]
        ]
        J.setInputSandbox(inp1 + inp2)
