...
AGENTS = [
    (
        "DIRAC.AccountingSystem.Agent.NetworkAgent",
        {"IgnoreOptions": ["MessageQueueURI"]},
    ),
    (
    ...
    (
        "DIRAC.ConfigurationSystem.Agent.GOCDB2CSAgent",
        {"IgnoreOptions": ["Cycles", "DryRun", "UpdatePerfSONARS"]},
    ),
    ...
    (
        "DIRAC.FrameworkSystem.Agent.SystemLoggingDBCleaner",
        {"IgnoreOptions": ["RemoveDate"]},
    ),
    ...
    (
        ...
        {
            "IgnoreOptions": ["FTSMode", "OperationHandlers"],
    ...
    (
        "DIRAC.StorageManagementSystem.Agent.StageRequestAgent",
        {"IgnoreOptions": ["PinLifetime"]},
    ),
    ("DIRAC.TransformationSystem.Agent.DataRecoveryAgent", {}),
    (
        "DIRAC.TransformationSystem.Agent.InputDataAgent",
        {"IgnoreOptions": ["DateKey", "TransformationTypes"]},
    ),
    (
    ...
    (
        "DIRAC.TransformationSystem.Agent.TransformationCleaningAgent",
        {"IgnoreOptions": ["EnableFlag", "shifterProxy"]},
    ),
    (
    ...
    (
        "DIRAC.WorkloadManagementSystem.Agent.JobAgent",
        {"IgnoreOptions": ["JobWrapperTemplate", "MinimumTimeLeft"]},
    ),
