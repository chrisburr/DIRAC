...
from DIRAC.ResourceStatusSystem.Utilities.RssConfiguration import (
    getValidElements,
    getValidStatus,
)
...
class Statistics(object):
    ...
    def getElementHistory(
        self, element, elementName, statusType, oldAs=None, newAs=None
    ):
        """
    ...
    def getElementStatusAt(self, element, elementName, statusType, statusTime):
        ...
        result = self.getElementHistory(
            element, elementName, statusType, statusTime, statusTime
        )
        if not result["OK"]:
            return result
        result = result["Value"]
    ...
    def getElementStatusTotalTimes(
        self, element, elementName, statusType, oldAs=None, newAs=None
    ):
        """
