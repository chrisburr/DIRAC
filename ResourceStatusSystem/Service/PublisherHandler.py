...
class PublisherHandler(RequestHandler):
    ...
    def export_getElementStatuses(
        self, element, name, elementType, statusType, status, tokenOwner
    ):
        """
        Returns element statuses from the ResourceStatusDB
        """

        return rsClient.selectStatusElement(
            element,
            "Status",
            name=name,
    ...
    def export_getElementPolicies(self, element, name, statusType):
        ...
        return rmClient.selectPolicyResult(
    ...
    def export_setToken(
        self, element, name, statusType, token, elementType, username, lastCheckTime
    ):
        ...
        elementInDB = rsClient.selectStatusElement(
            element,
            "Status",
            name=name,
            statusType=statusType,
        ...
        newStatus = rsClient.addOrModifyStatusElement(
            element,
            "Status",
            name=name,
            statusType=statusType,
    ...
    def export_getDowntimes(self, element, elementType, name):
        ...
        return rmClient.selectDowntimeCache(
            ...
            name=names,
            meta={
                "columns": ["StartDate", "EndDate", "Link", "Description", "Severity"]
            },
        )
    ...
    def export_getCachedDowntimes(self, element, elementType, name, severity):
        ...
        res = rmClient.selectDowntimeCache(
    ...
    def export_setStatus(
        self, element, name, statusType, status, elementType, username, lastCheckTime
    ):
