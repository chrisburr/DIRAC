...
class FreeDiskSpacePolicy_Success(FreeDiskSpacePolicy_TestCase):
    ...
    def test_evaluate(self):
        ...
        res = module._evaluate(
            {"OK": True, "Value": {"Total": 100, "Free": 4.0, "Guaranteed": 1}}
        )
        self.assertTrue(res["OK"])
        ...
        res = module._evaluate(
            {"OK": True, "Value": {"Total": 100, "Free": 100, "Guaranteed": 1}}
        )
        self.assertTrue(res["OK"])
...
if __name__ == "__main__":
    suite = unittest.defaultTestLoader.loadTestsFromTestCase(
        FreeDiskSpacePolicy_TestCase
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(FreeDiskSpacePolicy_Success)
    )
