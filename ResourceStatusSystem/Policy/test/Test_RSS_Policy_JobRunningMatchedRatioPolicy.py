...
class JobRunningMatchedRatioPolicy_Success(JobRunningMatchedRatioPolicy_TestCase):
    ...
    def test_evaluate(self):
        ...
        res = module._evaluate(
            {
                "OK": True,
                "Value": [{"Running": 0, "Matched": 0, "Received": 0, "Checking": 0}],
            }
        )
        self.assertTrue(res["OK"])
        self.assertEqual("Unknown", res["Value"]["Status"])
        ...
        res = module._evaluate(
            {
                "OK": True,
                "Value": [{"Running": 1, "Matched": 1, "Received": 0, "Checking": 0}],
            }
        )
        self.assertTrue(res["OK"])
        self.assertEqual("Unknown", res["Value"]["Status"])
        ...
        res = module._evaluate(
            {
                "OK": True,
                "Value": [{"Running": 10, "Matched": 10, "Received": 0, "Checking": 0}],
            }
        )
        self.assertTrue(res["OK"])
        ...
        res = module._evaluate(
            {
                "OK": True,
                "Value": [{"Running": 7, "Matched": 1, "Received": 1, "Checking": 1}],
            }
        )
        self.assertTrue(res["OK"])
        ...
        res = module._evaluate(
            {
                "OK": True,
                "Value": [{"Running": 70, "Matched": 0, "Received": 0, "Checking": 0}],
            }
        )
        self.assertTrue(res["OK"])
...
if __name__ == "__main__":
    suite = unittest.defaultTestLoader.loadTestsFromTestCase(
        JobRunningMatchedRatioPolicy_TestCase
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
            JobRunningMatchedRatioPolicy_Success
        )
    )
