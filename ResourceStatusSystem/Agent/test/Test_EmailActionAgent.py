...
class TestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.agent_m = importlib.import_module(
        ...
        self.action_m = importlib.import_module(
            "DIRAC.ResourceStatusSystem.PolicySystem.Actions.EmailAction"
        )
        ...
        enforcementResult = {
            ...
            "Reason": "test ###",
            "PolicyAction": [
                ("LogStatusAction", "LogStatusAction"),
        ...
        with patch.dict(os.environ):
            ...
            self.action = EmailAction(
                name, decisionParams, enforcementResult, singlePolicyResults
            )
