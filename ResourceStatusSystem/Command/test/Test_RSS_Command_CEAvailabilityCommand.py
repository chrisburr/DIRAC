...
class CEAvailabilityCommand_TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.CEAvailabilityCommand_m = importlib.import_module(
            "DIRAC.ResourceStatusSystem.Command.CEAvailabilityCommand"
        )
...
class CEAvailabilityCommand_Success(CEAvailabilityCommand_TestCase):
    ...
    def test_doCommand(self):
        ...
        res = command.doCommand()
        self.assertNotEqual(
            res["Value"]["Status"], "Production", "Test: it's not Production "
        )
...
if __name__ == "__main__":
    suite = unittest.defaultTestLoader.loadTestsFromTestCase(
        CEAvailabilityCommand_TestCase
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(CEAvailabilityCommand_Success)
    )
