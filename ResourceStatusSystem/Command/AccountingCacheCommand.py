...
class FailedJobsBySiteSplittedCommand(Command):
    ...
    def doCommand(self):
        ...
        failedJobs["data"] = {
            site: strToIntDict(value) for site, value in failedJobs["data"].iteritems()
        }
...
class SuccessfullPilotsByCESplittedCommand(Command):
    ...
    def doCommand(self):
        ...
        successfulPilots["data"] = {
            site: strToIntDict(value)
            for site, value in successfulPilots["data"].iteritems()
        }
...
class RunningJobsBySiteSplittedCommand(Command):
    ...
    def doCommand(self):
        ...
        runJobs = self.rClient.getReport(
            "WMSHistory", "NumberOfJobs", fromD, toD, {}, "Site"
        )
        if not runJobs["OK"]:
            return runJobs
        ...
        runJobs["data"] = {
            site: strToIntDict(value) for site, value in runJobs["data"].iteritems()
        }
