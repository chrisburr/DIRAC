...
class DIRACAccountingCommand(Command):
    ...
    def doCommand(self):
        ...
        return self.rClient.getReport(
            accounting, plot, fromT, toT, conditions, grouping
        )
...
class TransferQualityCommand(Command):
    ...
    def doCommand(self):
        ...
        pr_q_d = {
            ...
            for channel, value in results["Value"]["data"].iteritems()
        }
...
class CachedPlotCommand(Command):
    ...
    def doCommand(self):
        ...
        results = self.rmClient.selectAccountingCache(
            name=name, plotType=plotType, plotName=plotName, meta=meta
        )
