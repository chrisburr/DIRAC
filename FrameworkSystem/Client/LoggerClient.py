...
class LoggerClient:
    def getMessagesByDate(
        self, beginDate=None, endDate=None, startRecord=0, maxRecords=100
    ):
        ...
        return loggingQuery.getMessages(
            {"beginDate": beginDate, "endDate": endDate}, [], startRecord, maxRecords
        )

    def getMessagesByFixedText(
        self, texts, beginDate=None, endDate=None, startRecord=0, maxRecords=100
    ):
        ...
        loggingQuery = RPCClient("Framework/SystemLoggingReport", timeout=10)
        return loggingQuery.getMessages(
            {"FixedTextString": texts, "beginDate": beginDate, "endDate": endDate},
            [],
            startRecord,
            maxRecords,
        )

    def getMessagesBySystem(
        self, system, beginDate=None, endDate=None, startRecord=0, maxRecords=100
    ):
        ...
        loggingQuery = RPCClient("Framework/SystemLoggingReport", timeout=10)
        return loggingQuery.getMessages(
            {"SystemName": system, "beginDate": beginDate, "endDate": endDate},
            [],
            startRecord,
            maxRecords,
        )

    def getMessagesBySite(
        self, site, beginDate=None, endDate=None, startRecord=0, maxRecords=100
    ):
        ...
        loggingQuery = RPCClient("Framework/SystemLoggingReport", timeout=10)
        return loggingQuery.getMessages(
            {"SiteName": site, "beginDate": beginDate, "endDate": endDate},
            [],
            startRecord,
            maxRecords,
        )
    ...
    def getMessagesByUser(
        self, userDN, beginDate=None, endDate=None, startRecord=0, maxRecords=100
    ):
        ...
        loggingQuery = RPCClient("Framework/SystemLoggingReport", timeout=10)
        return loggingQuery.getMessages(
            {"OwnerDN": userDN, "beginDate": beginDate, "endDate": endDate},
            [],
            startRecord,
            maxRecords,
        )

    def getMessagesByGroup(
        self, group, beginDate=None, endDate=None, startRecord=0, maxRecords=100
    ):
        ...
        loggingQuery = RPCClient("Framework/SystemLoggingReport", timeout=10)
        return loggingQuery.getMessages(
            {"OwnerGroup": group, "beginDate": beginDate, "endDate": endDate},
            [],
            startRecord,
            maxRecords,
        )

    def getMessagesBySiteNode(
        self, node, beginDate=None, endDate=None, startRecord=0, maxRecords=100
    ):
        ...
        loggingQuery = RPCClient("Framework/SystemLoggingReport", timeout=10)
        return loggingQuery.getMessages(
            {"ClientFQDN": node, "beginDate": beginDate, "endDate": endDate},
            [],
            startRecord,
            maxRecords,
        )
    ...
    def getCountMessages(
        self, conds={}, beginDate=None, endDate=None, startRecord=0, maxRecords=100
    ):
    ...
    def getGroupedMessages(
        ...
        loggingQuery = RPCClient("Framework/SystemLoggingReport", timeout=10)
        result = loggingQuery.getGroupedMessages(
            conds, orderList, startRecord, maxRecords
        )
        if not result["OK"]:
            return result
