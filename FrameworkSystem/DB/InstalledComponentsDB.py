...
class Host(componentsBase):
    ...
    def toDict(self, includeInstallations=False, includeComponents=False):
        ...
        if includeInstallations:
            installations = []
            for installation in self.installationList:
                relationshipDict = installation.toDict(includeComponents, False)[
                    "Value"
                ]
                installations.append(relationshipDict)
            dictionary["Installations"] = installations
...
class InstalledComponent(componentsBase):
    ...
    componentID = Column(
        "ComponentID", Integer, ForeignKey("Components.ComponentID"), primary_key=True
    )
    ...
    def fromDict(self, dictionary):
        ...
        self.installationTime = dictionary.get(
            "InstallationTime", self.installationTime
        )
        self.unInstallationTime = dictionary.get(
...
class InstalledComponentsDB(object):
    ...
    def __initializeDB(self):
        ...
        if "InstalledComponents" not in tablesInDB:
            try:
                InstalledComponent.__table__.create(
                    self.engine
    ...
    def getComponents(
        self, matchFields={}, includeInstallations=False, includeHosts=False
    ):
        """
    ...
    def getHosts(
        self, matchFields={}, includeInstallations=False, includeComponents=False
    ):
        """
    ...
    def addInstalledComponent(
        self, newInstallation, componentDict, hostDict, forceCreate=False
    ):
        """
