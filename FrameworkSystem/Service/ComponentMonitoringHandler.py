...
class ComponentMonitoringHandler(RequestHandler):
    ...
    def export_addInstallation(
        self, installation, componentDict, hostDict, forceCreate
    ):
        """
    ...
    def export_installationExists(
        self, installationFields, componentFields, hostFields
    ):
        """
        ...
        matchFields = self.__joinInstallationMatch(
            installationFields, componentFields, hostFields
        )["Value"]
    ...
    def export_getInstallations(
        self, installationFields, componentFields, hostFields, installationsInfo
    ):
        """
    ...
    def export_updateInstallations(
        self, installationFields, componentFields, hostFields, updates
    ):
        """
    ...
    def export_removeInstallations(
        self, installationFields, componentFields, hostFields
    ):
        """
    ...
    def export_updateLog(self, host, fields):
        ...
        if result["Value"]:
            result = ComponentMonitoringHandler.db.updateLogs(
                {"hostName": host}, fields
            )
        else:
