...
class SystemLoggingReportHandler(RequestHandler):
    ...
    def export_getMessages(
        self, selectionDict={}, sortList=[], startItem=0, maxItems=0
    ):
    ...
    def export_getFixedTextStrings(
        self, selectionDict={}, sortList=[], startItem=0, maxItems=0
    ):
