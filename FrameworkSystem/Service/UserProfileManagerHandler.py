...
class UserProfileManagerHandler(RequestHandler):
    ...
    def export_retrieveProfileVar(self, profileName, varName):
        ...
        return gUPDB.retrieveVar(
            userName, userGroup, userName, userGroup, profileName, varName
        )

    types_retrieveProfileVarFromUser = [
        types.StringTypes,
        types.StringTypes,
        types.StringTypes,
        types.StringTypes,
    ...
    def export_retrieveProfileVarFromUser(
        self, ownerName, ownerGroup, profileName, varName
    ):
        ...
        userGroup = credDict["group"]
        return gUPDB.retrieveVar(
            userName, userGroup, ownerName, ownerGroup, profileName, varName
        )
    ...
    types_setProfileVarPermissions = [
        types.StringTypes,
        types.StringTypes,
        types.DictType,
    ]
