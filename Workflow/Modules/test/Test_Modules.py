...
class ModulesTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.rm_mock.putStorageDirectory.return_value = {
            "OK": True,
            "Value": {"Failed": False},
        }
        self.rm_mock.addCatalogFile.return_value = {
            "OK": True,
            "Value": {"Failed": False},
        }
        self.rm_mock.putAndRegister.return_value = {
            "OK": True,
            "Value": {"Failed": False},
        }
        ...
        self.ft_mock = Mock()
        self.ft_mock.transferAndRegisterFile.return_value = {
            "OK": True,
            "Value": {"uploadedSE": ""},
        }
        self.ft_mock.transferAndRegisterFileFailover.return_value = {
            "OK": True,
            "Value": {},
        }
        ...
        self.step_commons = [
            {
                ...
                "listoutput": [
                    {
                        "outputDataName": str(self.prod_id)
                        + "_"
                        + str(self.prod_job_id)
                        + "_",
                        "outputDataSE": "aaa",
                        "outputDataType": "bbb",
                    }
...
class ModuleBaseSuccess(ModulesTestCase):
    ...
    def test__applyMask(self):
        ...
        results = (
            ...
            {"00012345_00012345_1.sim": {"type": "sim", "workflowSE": "Tier1-RDST"}},
            {
                "00012345_00012345_2.digi": {
                    "type": "digi",
                    "workflowSE": "Tier1-RDST",
                },
            },
            {
                "00012345_00012345_3.digi": {
                    "type": "digi",
                    "workflowSE": "Tier1-RDST",
                },
                "00012345_00012345_1.sim": {"type": "sim", "workflowSE": "Tier1-RDST"},
        ...
        outputList = [
            {
                ...
                "outputDataName": "foo_1.txt",
            },
            {
                "outputDataType": "py",
                "outputDataSE": "Tier1-RDST",
                "outputDataName": "bar_2.py",
            },
        ]
        outputLFNs = [
...
if __name__ == "__main__":
    ...
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(FailoverRequestSuccess)
    )
