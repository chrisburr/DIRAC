...
class UtilitiesTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.ci = ConsistencyInspector(
            transClient=MagicMock(), dm=dmMock, fc=fc_mock, dic=dicMock
        )
...
class ConsistencyInspectorSuccess(UtilitiesTestCase):
    def test_getReplicasPresence(self):
        res = self.ci.getReplicasPresence(
            ["/this/is/dir1/file1.txt", "/this/is/dir1/file2.foo.bar"]
        )
        self.assertEqual(
            res, (["/this/is/dir1/file1.txt", "/this/is/dir1/file2.foo.bar"], [])
        )
...
if __name__ == "__main__":
    ...
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(ConsistencyInspectorSuccess)
    )
