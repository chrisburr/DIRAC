...
class FTS3Client(Client):
    ...
    def getActiveJobs(
        self, limit=20, lastMonitor=None, jobAssignmentTag="Assigned", **kwargs
    ):
    ...
    def getNonFinishedOperations(
        self, limit=20, operationAssignmentTag="Assigned", **kwargs
    ):
        ...
        try:
            ...
            return S_ERROR(
                0, "Exception when decoding the non finished operations json %s" % e
            )
