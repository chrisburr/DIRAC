...
class MoveReplicaSuccess(ReqOpsTestCase):
    ...
    def test__dmRemoval(self):
        ...
        res = {
            "OK": True,
            "Value": {
                "Successful": {self.File.LFN: {"DIRACFileCatalog": True}},
                "Failed": {},
            },
        }
...
class MoveReplicaFailure(ReqOpsTestCase):
    ...
    def test__dmTransfer(self):
        ...
        res = {
            ...
            "Value": {
                "Successful": {},
                "Failed": {self.File.LFN: "Unable to replicate file"},
            },
        }
        self.mr.dm.replicateAndRegister.return_value = res
    ...
    def test__dmRemoval(self):
        ...
        resvalue = dict(
            [
                (targetSE, "Write access not permitted for this credential")
    ...
    def test__addMetadataToFiles(self):
        ...
        for lfn in toSchedule:
            ...
            for attr in ("GUID", "Size", "Checksum"):
                self.assertEqual(
                    getattr(res["Value"][lfn], attr),
                    resMeta["Value"]["Successful"][lfn][attr],
                )
...
if __name__ == "__main__":
    ...
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(ReplicateAndRegisterSuccess)
    )
