...
from DIRAC.DataManagementSystem.DB.FileCatalogComponents.FileMetadata.FileMetadata import (
    FileMetadata,
)
...
class MultiVOFileMetadata(FileMetadata):
    ...
    def removeMetadata(self, dPath, metaList, credDict):
        ...
        result = super(MultiVOFileMetadata, self).removeMetadata(
    ...
    def setFileMetaParameter(self, path, metaName, metaValue, credDict):
        ...
        return super(MultiVOFileMetadata, self).setFileMetaParameter(
            path, fName, metaValue, credDict
        )
    ...
    def findFilesByMetadata(self, metaDict, path, credDict):
        ...
        fMetaDict = _getMetaNameDict(metaDict, credDict)
        return super(MultiVOFileMetadata, self).findFilesByMetadata(
            fMetaDict, path, credDict
        )
