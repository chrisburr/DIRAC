...
class TestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        mock_getDatabaseSection.return_value = (
            "/Systems/AccountingSystem/Certification/Databases/AccountingDB"
        )
        ...
        self.moduleTested.AccountingDB._AccountingDB__loadCatalogFromDB = (
            mock_loadCatalogFromDB
        )
...
class MakeQuery(TestCase):
    ...
    def test_calculateBuckets(self):
        ...
        retVal = module.calculateBuckets(
            "LHCb-Certification_DataOperation", 1495328400, 1495328400
        )[0][0]
        self.assertTrue(retVal)

        retVal = module.calculateBuckets(
            "LHCb-Certification_DataOperation", 1497964315, 1497964315
        )[0][0]
        self.assertTrue(retVal)
        self.assertTrue(retVal)

        retVal = module.calculateBuckets(
            "LHCb-Certification_DataOperation", 1495414800, 1495414800
        )[0][0]
        self.assertTrue(retVal)

        retVal = module.calculateBuckets(
            "LHCb-Certification_DataOperation", 1498047038, 1498047038
        )[0][0]
        self.assertTrue(retVal)
    ...
    def test__queryType1(self):
        ...
        endTime = 1497960715
        retVal = module.calculateBuckets(
            "LHCb-Certification_DataOperation", startTime + 3600, startTime + 3600
        )[0][0]
        self.assertTrue(retVal)
        expectedStartTime = retVal

        retVal = module.calculateBuckets(
            "LHCb-Certification_DataOperation", endTime + 3600, endTime + 3600
        )[0][0]
        self.assertTrue(retVal)
