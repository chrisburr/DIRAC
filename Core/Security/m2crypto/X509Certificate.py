...
class X509Certificate(object):
    ...
    @classmethod
    def generateProxyCertFromIssuer(
        cls, x509Issuer, x509ExtensionStack, proxyKey, lifetime=3600
    ):
    ...
    def loadFromString(self, pemData):
        ...
        """
        try:
            self.__certObj = M2Crypto.X509.load_cert_string(
                str(pemData), M2Crypto.X509.FORMAT_PEM
            )
