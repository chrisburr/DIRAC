...
class StepDefinition(AttributeCollection):
    ...
    def __str__(self):
        ret = (
            str(type(self))
            + ":\n"
            + AttributeCollection.__str__(self)
    ...
    def createModuleInstance(self, module_type, name):
        ...
        if self.module_definitions[module_type]:
            ...
            raise KeyError(
                "Can not find ModuleDefinition "
                + module_type
                + " to create ModuleInstrance "
                + name
            )
            ...
            if not inst.parameters.find("JOB_ID"):
                inst.parameters.append(
                    Parameter(
                        ...
                        True,
                        False,
                        "Job ID within a Production as a string",
                    )
                )
                    ...
                    if parameter.isLinked():
                        ...
                        if parameter.getLinkedModule() == "self":
                            ...
                            setattr(
                                ...
                                parameter.getName(),
                                getattr(
                                    step_exec_modules[parameter.getLinkedModule()],
                        ...
                        if parameter.isOutput():
                            ...
                            if parameter.isLinked():
                                ...
                                if parameter.getLinkedModule() == "self":
                                    ...
                                    print(
                                        "Warning! Module OUTPUT attribute",
                                        parameter.getName(),
                                        end=" ",
                                    )
                                    print(
            ...
            if st_parameter.isOutput():
                ...
                if st_parameter.isLinked():
                    ...
                    if st_parameter.getLinkedModule() == "self":
                        # this is not supposed to happen
                        print(
                            "Warning! Step OUTPUT attribute",
                            st_parameter.getName(),
                            end=" ",
                        )
                        print(
                        ...
                        step_exec_attr[st_parameter.getName()] = step_exec_attr[
                            st_parameter.getLinkedParameter()
                        ]
