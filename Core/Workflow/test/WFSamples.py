...
op1 = Parameter(
    "enable", "True", "bool", "", "", True, False, "if False execution disabled"
)
op2 = Parameter(
    "version", "1.25", "float", "", "", False, True, "we can get version of the module"
)
# op3 = Parameter("message","\'this is ugly module\'","string","","",False,False,"message for the printing")
op3 = Parameter(
    "message", "@{inparam4}", "string", "", "", False, False, "message for the printing"
)
op4 = Parameter(
    "debug",
    "False",
...
sd1.addParameter(
    Parameter("enable_inst1", "True", "bool", "", "", True, True, "enabling instance 1")
)
sd1.addParameter(
    Parameter("enable_inst2", "True", "bool", "", "", True, True, "enabling instance 2")
)
sd1.addParameter(
    Parameter("enable_inst3", "True", "bool", "", "", True, True, "enabling instance 3")
)
sd1.addParameter(
    Parameter(
        "debug", "True", "bool", "", "", True, True, "enabling additional printing"
    )
)
...
sd1.addParameter(
    Parameter("message", "@{inparam4}", "string", "", "", True, False, "output")
)
...
mlistdict = [
    {"SORTIE_@{inparam4}": 4098, "sape_@{inpar2}": 4139},
...
w1.addParameter(
    Parameter(
        "message", "vv@{inparam4}jj@{inpar2}ge", "string", "", "", True, False, ""
    )
)
