...
module2.addParameter(
    Parameter("DataType", "", "string", "self", "DataType", True, False, "data type")
)
module2.addParameter(
    Parameter(
        "CONFIG_NAME",
...
module2.addParameter(
    Parameter("EVENTTYPE", "", "string", "self", "EVENTTYPE", True, False, "Event Type")
)
module2.addParameter(
    Parameter(
        "appName", "", "string", "self", "appName", True, False, "Application Name"
    )
)
module2.addParameter(
    Parameter(
...
module2.addParameter(
    Parameter(
        "appType", "", "string", "self", "appType", True, False, "Application Version"
    )
)
module2.addParameter(
    Parameter("appLog", "", "string", "self", "appLog", True, False, "list of logfile")
)
module2.addParameter(
    Parameter(
        "inputData", "", "jdl", "self", "inputData", True, False, "List of InputData"
    )
)
module2.addParameter(
    Parameter(
...
module2.addParameter(
    Parameter(
        "optionsFile", "", "string", "self", "optionsFile", True, False, "Options File"
    )
)
module2.addParameter(
    Parameter(
...
module3.addParameter(
    Parameter(
        "SourceData", "", "string", "self", "SourceData", True, False, "InputData"
    )
)
module3.addParameter(
    Parameter(
...
module3.addParameter(
    Parameter("inputData", "", "string", "self", "inputData", True, False, "InputData")
)
module3.addParameter(
    Parameter(
        "OUTPUT_MAX",
...
module3.addParameter(
    Parameter("EMAIL", "@{EMAILNAME}", "string", "", "", True, False, "EMAIL adress")
)
...
module4.addParameter(
    Parameter("STEP_ID", "", "string", "self", "STEP_ID", True, False, "EMAIL adress")
)
module4.addParameter(
    Parameter(
        "NUMBER_OF_EVENTS",
...
moduleInstance4.setLink(
    "NUMBER_OF_EVENTS_INPUT", moduleInstance3.getName(), "NUMBER_OF_EVENTS_INPUT"
)
moduleInstance4.setLink(
    "NUMBER_OF_EVENTS_OUTPUT", moduleInstance3.getName(), "NUMBER_OF_EVENTS_OUTPUT"
)
...
step1.addParameter(
    Parameter("EVENTTYPE", "30000000", "string", "", "", True, False, "Event Type")
)
step1.addParameter(
    Parameter(
        "outputData", "@{STEP_ID}.root", "string", "", "", True, False, "etc name"
    )
)
step1.addParameter(
    Parameter("etcf", "SETC_@{STEP_ID}.root", "string", "", "", True, False, "etc name")
)
...
step1.addParameter(
    Parameter("listoutput", [], "list", "", "", True, False, "list of output data")
)
...
opt_brunel = (
    opt_brunel + ';EventPersistencySvc.CnvServices += { "LHCb::RawDataCnvSvc" }'
)
...
stepInstance1.setLink(
    "systemConfig", "self", "SystemConfig"
)  # capital letter corrected
...
)  # KGG linked with InputData of the Workflow
list1_out = [
    {
...
workflow1.addParameter(
    Parameter("InputData", indata, "JDL", "", "", True, False, "Application Name")
)
workflow1.addParameter(
    Parameter("JobType", "test", "JDL", "", "", True, False, "Job TYpe")
)
workflow1.addParameter(
    Parameter("AncestorDepth", "2", "JDL", "", "", True, False, "Ancestor Depth")
)
workflow1.addParameter(
...
workflow1.addParameter(
    Parameter("StdOutput", "std.out", "JDL", "", "", True, False, "user Name")
)
workflow1.addParameter(
    Parameter(
        "SoftwarePackages", "Brunel.v32r4", "JDL", "", "", True, False, "software"
    )
)

workflow1.addParameter(
    Parameter("MaxCPUTime", 300000, "JDLReqt", "", "", True, False, "Application Name")
)
# workflow1.addParameter(Parameter("Site","LCG.CERN.ch","JDLReqt","","",True, False, "Site"))
workflow1.addParameter(
    Parameter("Platform", "gLite", "JDLReqt", "", "", True, False, "platform")
)
...
workflow1.addParameter(
    Parameter(
        "PRODUCTION_ID", "00003033", "string", "", "", True, False, "Temporary fix"
    )
)
workflow1.addParameter(
    Parameter("JOB_ID", "00000011", "string", "", "", True, False, "Temporary fix")
)
workflow1.addParameter(
    Parameter(
        "EMAILNAME",
...
workflow1.addParameter(
    Parameter("DataType", "DATA", "string", "", "", True, False, "type of Datatype")
)
workflow1.addParameter(
    Parameter("SourceData", indata, "string", "", "", True, False, "Application Name")
)
workflow1.addParameter(
    Parameter(
        "poolXMLCatName",
...
workflow1.addParameter(
    Parameter(
        "CONFIG_NAME", "LHCb", "string", "", "", True, False, "Configuration Name"
    )
)
workflow1.addParameter(
    Parameter(
