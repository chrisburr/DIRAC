...
XML_node_ongoing += (
    ' CLASSIFICATION="SCHEDULED"><HOSTNAME>egse-cresco.portici.enea.it</HOSTNAME>'
)
...
xml_endpoint_and_affected_ongoing += (
    '<DOWNTIME ID="29118" PRIMARY_KEY="109962G0" CLASSIFICATION="UNSCHEDULED">'
)
...
xml_endpoint_and_affected_ongoing += (
    "<GOCDB_PORTAL_URL>https://goc.egi.eu/bof</GOCDB_PORTAL_URL>"
)
...
xml_endpoint_and_affected_ongoing += (
    "<FORMATED_START_DATE>" + nowLess12h + "</FORMATED_START_DATE>"
)
xml_endpoint_and_affected_ongoing += (
    "<FORMATED_END_DATE>" + nowPlus24h + "</FORMATED_END_DATE>"
)
...
xml_endpoint_and_affected_ongoing_broken += (
    "<ENDPOINT>lhcbsrm-kit.gridka.deSRM</ENDPOINT>"
)
...
xml_endpoint_and_affected_ongoing_broken += (
    "<DESCRIPTION>Namespace reordering</DESCRIPTION>"
)
...
xml_endpoint_and_affected_ongoing_no_url += (
    '<DOWNTIME ID="29118" PRIMARY_KEY="109962G0" CLASSIFICATION="UNSCHEDULED">'
)
...
xml_endpoint_and_affected_ongoing_2_endpoints += (
    '<DOWNTIME ID="29109" PRIMARY_KEY="123" CLASSIFICATION="SCHEDULED">'
)
xml_endpoint_and_affected_ongoing_2_endpoints += "<PRIMARY_KEY>123</PRIMARY_KEY>"
xml_endpoint_and_affected_ongoing_2_endpoints += (
    "<HOSTNAME>appsgrycap.i3m.upv.es</HOSTNAME>"
)
xml_endpoint_and_affected_ongoing_2_endpoints += (
    "<SERVICE_TYPE>es.upv.grycap.im</SERVICE_TYPE>"
)
xml_endpoint_and_affected_ongoing_2_endpoints += (
    "<ENDPOINT>appsgrycap.i3m.upv.eses.upv.grycap.im</ENDPOINT>"
)
...
xml_endpoint_and_affected_ongoing_2_endpoints += (
    "<URL>https://appsgrycap.i3m.upv.es:31443/im-web/</URL>"
)
xml_endpoint_and_affected_ongoing_2_endpoints += (
    "<INTERFACENAME>es.upv.grycap.im</INTERFACENAME>"
)
xml_endpoint_and_affected_ongoing_2_endpoints += (
...
xml_endpoint_and_affected_ongoing_2_endpoints += (
    "<URL>https://appsgrycap.i3m.upv.es:31443/im/</URL>"
)
xml_endpoint_and_affected_ongoing_2_endpoints += (
    "<INTERFACENAME>es.upv.grycap.im</INTERFACENAME>"
)
...
xml_endpoint_and_affected_ongoing_2_endpoints += (
    "<DESCRIPTION>maintenance of the facilities</DESCRIPTION>"
)
...
XML_nodesite_ongoing += (
    ' CLASSIFICATION="SCHEDULED"><SITENAME>GRISU-ENEA-GRID</SITENAME>'
)
XML_nodesite_ongoing += "<SEVERITY>OUTAGE</SEVERITY>"
...
XML_site_ongoing_and_site_starting_in_24_hours = (
    '<?xml version="1.0"?>\n<ROOT><DOWNTIME ID="78505456"'
)
XML_site_ongoing_and_site_starting_in_24_hours += (
    ' PRIMARY_KEY="28490G1" CLASSIFICATION="SCHEDULED">'
)
...
XML_site_ongoing_and_site_starting_in_24_hours += (
    "<DESCRIPTION>Software problems SITE</DESCRIPTION>"
)
XML_site_ongoing_and_site_starting_in_24_hours += (
    "<INSERT_DATE>1276273965</INSERT_DATE>"
)
...
XML_site_ongoing_and_site_starting_in_24_hours += (
    "<FORMATED_END_DATE>" + nowPlus8h + "</FORMATED_END_DATE>"
)
XML_site_ongoing_and_site_starting_in_24_hours += (
    "<GOCDB_PORTAL_URL>https://bof</GOCDB_PORTAL_URL>"
)
XML_site_ongoing_and_site_starting_in_24_hours += "</DOWNTIME>"
XML_site_ongoing_and_site_starting_in_24_hours += (
    '<DOWNTIME ID="78505457" PRIMARY_KEY="28490G0"'
)
XML_site_ongoing_and_site_starting_in_24_hours += ' CLASSIFICATION="SCHEDULED">'
XML_site_ongoing_and_site_starting_in_24_hours += "<SITENAME>GRISU-ENEA-GRID</SITENAME>"
XML_site_ongoing_and_site_starting_in_24_hours += "<SEVERITY>OUTAGE</SEVERITY>"
XML_site_ongoing_and_site_starting_in_24_hours += (
    "<DESCRIPTION>Software problems SITE 2</DESCRIPTION>"
)
XML_site_ongoing_and_site_starting_in_24_hours += (
    "<INSERT_DATE>1276273965</INSERT_DATE>"
)
...
XML_site_ongoing_and_site_starting_in_24_hours += "<END_DATE>1276878660</END_DATE>"
XML_site_ongoing_and_site_starting_in_24_hours += (
    "<FORMATED_START_DATE>" + nowPlus24h + "</FORMATED_START_DATE>"
)
XML_site_ongoing_and_site_starting_in_24_hours += (
    "<FORMATED_END_DATE>" + nowPlus40h + "</FORMATED_END_DATE>"
)
XML_site_ongoing_and_site_starting_in_24_hours += (
    "<GOCDB_PORTAL_URL>https://bof</GOCDB_PORTAL_URL>"
)
...
XML_site_startingIn24h_and_site_startingIn50h += (
    '<DOWNTIME ID="78505456" PRIMARY_KEY="28490G1"'
)
...
XML_site_startingIn24h_and_site_startingIn50h += (
    '</DOWNTIME><DOWNTIME ID="78505457" PRIMARY_KEY="28490G0"'
)
XML_site_startingIn24h_and_site_startingIn50h += ' CLASSIFICATION="SCHEDULED">'
XML_site_startingIn24h_and_site_startingIn50h += "<SITENAME>GRISU-ENEA-GRID</SITENAME>"
XML_site_startingIn24h_and_site_startingIn50h += "<SEVERITY>OUTAGE</SEVERITY>"
...
XML_site_startingIn24h_and_site_startingIn50h += "<END_DATE>1276878660</END_DATE>"
XML_site_startingIn24h_and_site_startingIn50h += (
    "<FORMATED_START_DATE>" + nowPlus50h + "</FORMATED_START_DATE>"
)
XML_site_startingIn24h_and_site_startingIn50h += (
    "<FORMATED_END_DATE>" + nowPlus60h + "</FORMATED_END_DATE>"
)
XML_site_startingIn24h_and_site_startingIn50h += (
    "<GOCDB_PORTAL_URL>https://bof</GOCDB_PORTAL_URL>"
)
...
XML_site_ongoing_and_other_site_starting_in_24_hours += (
    "<SITENAME>GRISU-ENEA-GRID</SITENAME>"
)
...
XML_site_ongoing_and_other_site_starting_in_24_hours += (
    "<START_DATE>1276360500</START_DATE>"
)
XML_site_ongoing_and_other_site_starting_in_24_hours += (
    "<END_DATE>1276878660</END_DATE>"
)
XML_site_ongoing_and_other_site_starting_in_24_hours += (
    "<FORMATED_START_DATE>" + nowLess12h + "</FORMATED_START_DATE>"
)
...
XML_node_ongoing_and_other_node_starting_in_24_hours += (
    "<HOSTNAME>egse-cresco.portici.enea.it</HOSTNAME>"
)
XML_node_ongoing_and_other_node_starting_in_24_hours += (
    "<HOSTED_BY>GRISU-ENEA-GRID</HOSTED_BY>"
)
XML_node_ongoing_and_other_node_starting_in_24_hours += "<SEVERITY>OUTAGE</SEVERITY>"
XML_node_ongoing_and_other_node_starting_in_24_hours += (
    "<DESCRIPTION>Software problems RESOURCE</DESCRIPTION>"
)
XML_node_ongoing_and_other_node_starting_in_24_hours += (
    "<INSERT_DATE>1276273965</INSERT_DATE>"
)
...
XML_node_ongoing_and_other_node_starting_in_24_hours += ' CLASSIFICATION="SCHEDULED">'
XML_node_ongoing_and_other_node_starting_in_24_hours += (
    "<HOSTNAME>ce112.cern.ch</HOSTNAME>"
)
XML_node_ongoing_and_other_node_starting_in_24_hours += (
    "<HOSTED_BY>CERN-PROD</HOSTED_BY>"
)
XML_node_ongoing_and_other_node_starting_in_24_hours += "<SEVERITY>OUTAGE</SEVERITY>"
XML_node_ongoing_and_other_node_starting_in_24_hours += (
    "<DESCRIPTION>Software problems RESOURCE 2</DESCRIPTION>"
)
XML_node_ongoing_and_other_node_starting_in_24_hours += (
    "<INSERT_DATE>1276273965</INSERT_DATE>"
)
...
def test__downTimeXMLParsing_affected():
    ...
    assert (
        res["109962G0 lhcbsrm-kit.gridka.deSRM"]["HOSTNAME"] == "lhcbsrm-kit.gridka.de"
    )
    assert (
        res["109962G0 lhcbsrm-kit.gridka.deSRM"]["URL"] == "lhcbsrm-disk-kit.gridka.de"
    )
    res = GOCCli._downTimeXMLParsing(xml_endpoint_and_affected_ongoing, "Site")
    assert res == {}

    res = GOCCli._downTimeXMLParsing(
        xml_endpoint_and_affected_ongoing_broken, "Resource"
    )
    assert list(res)[0] == "109962G0 lhcbsrm-kit.gridka.deSRM"
    assert (
        res["109962G0 lhcbsrm-kit.gridka.deSRM"]["HOSTNAME"] == "lhcbsrm-kit.gridka.de"
    ...
    res = GOCCli._downTimeXMLParsing(
        xml_endpoint_and_affected_ongoing_no_url, "Resource"
    )
    assert list(res)[0] == "109962G0 lhcbsrm-kit.gridka.deSRM"
    assert (
        res["109962G0 lhcbsrm-kit.gridka.deSRM"]["HOSTNAME"] == "lhcbsrm-kit.gridka.de"
    ...
    res = GOCCli._downTimeXMLParsing(
        xml_endpoint_and_affected_ongoing_2_endpoints, "Resource"
    )
    assert list(res)[0] == "123 appsgrycap.i3m.upv.eses.upv.grycap.im"
    assert (
        res["123 appsgrycap.i3m.upv.eses.upv.grycap.im"]["HOSTNAME"]
        == "appsgrycap.i3m.upv.es"
    )
    assert (
        res["123 appsgrycap.i3m.upv.eses.upv.grycap.im"]["URL"]
        == "https://appsgrycap.i3m.upv.es:31443/im-web/"
    )
    res = GOCCli._downTimeXMLParsing(
        xml_endpoint_and_affected_ongoing_2_endpoints, "Site"
    )
    assert res == {}
...
def test__downTimeXMLParsing():
    ...
    assert (
        res["28490G0 egse-cresco.portici.enea.it"]["HOSTNAME"]
    ...
    res = GOCCli._downTimeXMLParsing(
        XML_site_ongoing_and_site_starting_in_24_hours, "Site", None, now
    )
    assert list(res)[0] == "28490G1 GRISU-ENEA-GRID"
    assert res["28490G1 GRISU-ENEA-GRID"]["SITENAME"] == "GRISU-ENEA-GRID"

    res = GOCCli._downTimeXMLParsing(
        XML_site_ongoing_and_site_starting_in_24_hours, "Resource", None, now
    )
    assert res == {}
    res = GOCCli._downTimeXMLParsing(
        XML_site_startingIn24h_and_site_startingIn50h, "Site", None, now
    )
    assert res == {}

    res = GOCCli._downTimeXMLParsing(
        XML_site_startingIn24h_and_site_startingIn50h, "Site", None, tomorrow
    )
    assert list(res)[0] == "28490G1 GRISU-ENEA-GRID"
    assert res["28490G1 GRISU-ENEA-GRID"]["SITENAME"] == "GRISU-ENEA-GRID"
    ...
    res = GOCCli._downTimeXMLParsing(
        XML_site_ongoing_and_other_site_starting_in_24_hours, "Site", "CERN-PROD"
    )
    assert list(res)[0] == "28490G0 CERN-PROD"
    assert res["28490G0 CERN-PROD"]["SITENAME"] == "CERN-PROD"
    res = GOCCli._downTimeXMLParsing(
        XML_site_ongoing_and_other_site_starting_in_24_hours, "Site", "CNAF-T1"
    )
    assert res == {}
    ...
    assert (
        res["28490G1 egse-cresco.portici.enea.it"]["HOSTNAME"]
        == "egse-cresco.portici.enea.it"
    )
    res = GOCCli._downTimeXMLParsing(
        XML_node_ongoing_and_other_node_starting_in_24_hours,
