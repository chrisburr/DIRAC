...
class AdlerTestCase(unittest.TestCase):
    ...
    def testConversion(self):
        ...
        # normal operation
        self.assertEqual(
            int(Adler.intAdlerToHex(1)), Adler.hexAdlerToInt(Adler.intAdlerToHex(1))
        )
        self.assertEqual(
            Adler.hexAdlerToInt("0x01"),
    ...
    def testFileAdler(self):
        ...
        # inexisting file
        self.assertEqual(
            Adler.fileAdler("Stone/Dead/Norwegian/Blue/Parrot/In/Camelot"), False
        )
        # normal operation
    ...
    def testCompareAdler(self):
        ...
        # same adlers
        self.assertEqual(
            Adler.compareAdler(Adler.stringAdler(""), Adler.stringAdler("")), True
        )
        # diff adlers
        self.assertEqual(
            Adler.compareAdler(
                Adler.stringAdler(""), Adler.stringAdler(string.letters)
            ),
            False,
        )
