...
class StatisticsTestCase(unittest.TestCase):
    ...
    def testgetStandardDeviation(self):
        ...
        self.assertEqual(
            getStandardDeviation(aList, variance=2.0 / 3.0), sqrt(2.0 / 3.0)
        )
        self.assertEqual(
            getStandardDeviation(aList, variance=2.0 / 3.0, mean=1.0), sqrt(2.0 / 3.0)
        )
        self.assertEqual(
            getStandardDeviation(aList, variance="Empty", mean=1.0), sqrt(5.0 / 3.0)
        )
