...
# # SUT
from DIRAC.Core.Utilities.Graph import (
    Node,
    Edge,
    Graph,
    DynamicProps,
...
class DynamicPropTests(unittest.TestCase):
    ...
    def testDynamicProps(self):
        ...
        # # .. and ro as well
        testObj.makeProperty(
            "roTestProp", "I'm read only", True
...
if __name__ == "__main__":
    ...
    tests = (
        ...
        for testCase in (DynamicPropTests, NodeTests, EdgeTests, GraphTests)
    )
