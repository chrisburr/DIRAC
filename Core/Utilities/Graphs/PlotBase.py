...
class PlotBase(object):
    ...
    def draw(self):
        ...
        ax_plot_rect = (
            ...
            float(plot_bottom_padding + bottom + x_label_space + stats_line_space)
            / f_height,
            float(width - plot_left_padding - plot_right_padding - y_label_space)
            / f_width,
            float(
                height
                - plot_bottom_padding
        ...
        if frame_flag.lower() == "off":
            ...
            if axis_grid_flag:
                ax.grid(
                    True, color="#555555", linewidth=pixelToPoint(grid_line_width, dpi)
                )
