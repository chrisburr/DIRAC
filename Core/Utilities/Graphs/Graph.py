...
class Graph(object):
    ...
    def layoutFigure(self, legend):
        ...
        if title:
            ...
            if subtitle:
                ...
                top_offset = (
                    subtitle_size + subtitle_padding + title_size + figure_padding
                )
        ...
        if legend_flag:
            ...
            if legend_position in ["right", "left"]:
                ...
                bottom = (
                    (height - title_size - title_padding - legend_height) / 2.0 / height
                )
    ...
    def makeGraph(self, data, *args, **kw):
        ...
        if (
            not graphData[0].subplots
            and graphData[0].key_type != "string"
            and not plot_type == "PieGraph"
        ):
            prefs["legend"] = False
        if (
            prefs["legend"]
            and graphData[0].key_type != "string"
            and plot_type == "PieGraph"
        ):
