...
class AuthManagerTest(unittest.TestCase):
    ...
    def test_userGroup(self):
        ...
        self.assertFalse(result)
        result = self.authMgr.authQuery(
            "MethodAllGroup", self.suspendedOtherVOUserCredDict
        )
        self.assertFalse(result)
        ...
        self.assertFalse(result)
        result = self.authMgr.authQuery(
            "MethodAllGroupOther", self.suspendedUserCredDict
        )
        self.assertFalse(result)
        result = self.authMgr.authQuery(
            "MethodAllGroupOther", self.suspendedOtherVOUserCredDict
        )
        self.assertTrue(result)
        ...
        self.assertFalse(result)
        result = self.authMgr.authQuery(
            "MethodAuthGroup", self.suspendedOtherVOUserCredDict
        )
        self.assertFalse(result)
        ...
        self.assertFalse(result)
        result = self.authMgr.authQuery(
            "MethodAuthGroupOther", self.suspendedUserCredDict
        )
        self.assertFalse(result)
        result = self.authMgr.authQuery(
            "MethodAuthGroupOther", self.suspendedOtherVOUserCredDict
        )
        self.assertTrue(result)
        ...
        self.assertFalse(result)
        result = self.authMgr.authQuery(
            "MethodGroup", self.suspendedOtherVOUserCredDict
        )
        self.assertFalse(result)
        ...
        self.assertFalse(result)
        result = self.authMgr.authQuery(
            "MethodGroupOther", self.suspendedOtherVOUserCredDict
        )
        self.assertTrue(result)
    ...
    def test_userVO(self):
        ...
        self.assertFalse(result)
        result = self.authMgr.authQuery(
            "MethodAllVO", self.suspendedOtherVOUserCredDict
        )
        self.assertFalse(result)
        ...
        self.assertFalse(result)
        result = self.authMgr.authQuery(
            "MethodAuthVO", self.suspendedOtherVOUserCredDict
        )
        self.assertFalse(result)
