...
class ProductionManagerHandlerBase(RequestHandler):
    ...
    def export_addTransformationsToProduction(prodName, transIDs, parentTransIDs):
        return database.addTransformationsToProduction(
            prodName, transIDs, parentTransIDs=parentTransIDs
        )
    ...
    def export_getProductionTransformations(
        ...
        if not condDict:
            condDict = {}
        return database.getProductionTransformations(
            prodName,
            condDict=condDict,
            older=older,
            newer=newer,
    ...
    def export_addProductionStep(prodStep):
        ...
        res = database.addProductionStep(
            stepName,
            stepDescription,
            stepLongDescription,
            stepBody,
