...
Script.registerSwitch(
    "R:", "Reconfig=", "Update given configuration file with the resulting value"
)
...
if __name__ == "__main__":
    ...
    from DIRAC.WorkloadManagementSystem.Client.DIRACbenchmark import (
    ...
    if update:
        gConfig.setOptionValue(
            "/LocalSite/CPUScalingFactor", hs06JobFeature if hs06JobFeature else norm
        )  # deprecate?
