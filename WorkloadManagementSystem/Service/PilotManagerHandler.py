...
class PilotManagerHandler(RequestHandler):
    ...
    def export_addPilotTQReference(
        ...
        return pilotDB.addPilotTQReference(
    ...
    def export_setPilotStatus(
        self, pilotRef, status, destination=None, reason=None, gridSite=None, queue=None
    ):
        """Set the pilot agent status"""

        return pilotDB.setPilotStatus(
            pilotRef,
            status,
    ...
    @classmethod
    def export_countPilots(
        cls, condDict, older=None, newer=None, timeStamp="SubmissionTime"
    ):
        """Set the pilot agent status"""
    ...
    def export_getCounters(
        cls, table, keys, condDict, newer=None, timeStamp="SubmissionTime"
    ):
        """Set the pilot agent status"""

        return pilotDB.getCounters(
            table, keys, condDict, newer=newer, timeStamp=timeStamp
        )
