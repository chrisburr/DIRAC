...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {
                "OK": True,
                "Value": {"1": {"Jobs": 10, "Sites": ["Site1"]}, "2": {"Jobs": 20}},
            },
            True,
            True,
            set(["Site1"]),
...
def test__ifAndWhereToSubmit(
    mocker, mockMatcherReturnValue, expected, anyExpected, sitesExpected
):
    ...
    [
        ...
        (
            ["aPilotRef"],
            {
                "aPilotRef": {
                    "Status": "Running",
                    "LastUpdateTime": datetime.datetime(2000, 1, 1).utcnow(),
                }
            },
            {},
            (0, []),
