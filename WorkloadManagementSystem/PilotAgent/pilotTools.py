...
def getCommand(params, commandName, log):
    ...
    if params.diracInstalled:
        ...
        for module in modules:
            commandObject, modulePath = ol.loadObject(
                "WorkloadManagementSystem.PilotAgent", module, commandName
            )
            if commandObject:
...
class PilotParams(object):
    ...
    def __init__(self):
        ...
        self.pilotCFGFileLocation = (
            "http://diracproject.web.cern.ch/diracproject/configs/"
        )
