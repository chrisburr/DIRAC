...
def test_execute(mocker):
    ...
    shutil.copy(
        "WorkloadManagementSystem/JobWrapper/test/script-RESC.sh", "script-RESC.sh"
    ...
    if res[
        "OK"
    ]:  # FIXME: This may happen depending on the shell - not the best test admittedly!
        print(
        ...
        assert (
            res["OK"] is False
        )  # In this case the application finished with an error code
