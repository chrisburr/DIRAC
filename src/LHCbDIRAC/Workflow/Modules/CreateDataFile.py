...
class CreateDataFile(ModuleBase):
    ...
    def execute(
        ...
        try:
            ...
            super(CreateDataFile, self).execute(
                production_id,
                prod_job_id,
                wms_job_id,
                workflowStatus,
            ...
            if not gdf:
                gdf = GangaDataFile(fileName=self.gangaFileName, xmlcatalog_file=self.poolXMLCatName, log=self.log)
            ...
            super(CreateDataFile, self).finalize()
