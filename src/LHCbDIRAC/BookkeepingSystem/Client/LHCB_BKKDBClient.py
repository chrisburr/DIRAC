...
class LHCB_BKKDBClient:
    ...
    def __init__(self, url=None, web=False, welcome=True):
        ...
        self.__ESManager = LHCbBookkeepingManager(url=url, web=web, welcome=welcome)
    ...
    def getLogicalFiles(self):
        """lfns."""
        return self.__ESManager.getLogicalFiles()  # pylint: disable=no-member
    ...
    def setVerbose(self, value):
        ...
        return self.__ESManager.setVerbose(value)  # pylint: disable=no-member
