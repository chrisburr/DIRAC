...
class StompMQConnector(MQConnector):
    ...
    RECONNECT_SLEEP_MAX = (
        120  # [s] The maximum delay that can be reached independent of increasing procedure.
    )
    RECONNECT_SLEEP_JITTER = (
        0.1  # Random factor to add. 0.1 means a random number from 0 to 10% of the current time.
    )
