...
class TestMQProducer_put(TestMQProducer):
    def test_success(self):
        producer = MQProducer(
            mqManager=self.myManager, mqURI="fake.cern.ch::Queues::FakeQueue", producerId="producer4"
        )
    ...
    def test_failure(self):
        producer = MQProducer(
            mqManager=self.myManager, mqURI="bad.cern.ch::Queues::FakeQueue", producerId="producer4"
        )
        result = producer.put("wow!")
