...
class TestMQConnectionStorageFunctions_destinationExists(TestMQConnectionManager):
    def test_success(self):
        self.assertTrue(
            self.mgr._MQConnectionManager__destinationExists("mardirac3.in2p3.fr", "/queue/test1")
        )
    ...
    def test_failure2(self):
        self.assertFalse(
            self.mgr._MQConnectionManager__destinationExists("mardirac3.in2p3.fr", "/queue/nonexisting")
        )
...
class TestMQConnectionStorageFunctions_messengerExists(TestMQConnectionManager):
    ...
    def test_failure(self):
        self.assertFalse(
            self.mgr._MQConnectionManager__messengerExists("noexisting", "/queue/test1", "producer4")
        )
...
class TestMQConnectionStorageFunctions_getMessengersId(TestMQConnectionManager):
    ...
    def test_success2(self):
        ...
        self.assertEqual(
            self.mgr._MQConnectionManager__getMessengersId("mardirac3.in2p3.fr", "/queue/test2"),
            expectedMess2,
        )
    ...
    def test_failure2(self):
        self.assertEqual(
            self.mgr._MQConnectionManager__getMessengersId("mardirac3.in2p3.fr", "nonexisiting"), []
        )
...
class TestMQConnectionStorageFunctions_getAllMessengersInfo(TestMQConnectionManager):
    def test_success(self):
        ...
        self.assertEqual(
            sorted(self.mgr._MQConnectionManager__getAllMessengersInfo()), sorted(expectedOutput)
        )
...
class TestMQConnectionStorageFunctions_getAllMessengersIdWithType(TestMQConnectionManager):
    def test_success(self):
        ...
        self.assertEqual(
            sorted(self.mgr._MQConnectionManager__getAllMessengersIdWithType("consumer")),
            sorted(expectedOutput),
        )
        expectedOutput = ["producer4", "producer2", "producer1", "producer1"]
        self.assertEqual(
            sorted(self.mgr._MQConnectionManager__getAllMessengersIdWithType("producer")),
            sorted(expectedOutput),
        )
...
class TestMQConnectionStorageFunctions_addMessenger(TestMQConnectionManager):
    def test_success(self):
        ...
        self.assertTrue(
            self.mgr._MQConnectionManager__addMessenger("mardirac3.in2p3.fr", "/queue/test1", "producer1")
        )
        self.assertEqual(
            sorted(self.mgr._MQConnectionManager__getAllMessengersInfo()), sorted(expectedOutput)
        )
    ...
    def test_success2(self):
        ...
        self.assertTrue(
            self.mgr._MQConnectionManager__addMessenger("mardirac3.in2p3.fr", "/queue/test5", "producer8")
        )
        self.assertEqual(
            sorted(self.mgr._MQConnectionManager__getAllMessengersInfo()), sorted(expectedOutput)
        )
    ...
    def test_success4(self):
        ...
        self.assertTrue(
            self.mgr._MQConnectionManager__addMessenger("mytest.is.the.best", "/queue/test10", "producer2")
        )
        self.assertEqual(
            sorted(self.mgr._MQConnectionManager__getAllMessengersInfo()), sorted(expectedOutput)
        )
    ...
    def test_failure(self):
        ...
        self.assertFalse(
            self.mgr._MQConnectionManager__addMessenger("mardirac3.in2p3.fr", "/queue/test1", "producer4")
        )
        self.assertEqual(
            sorted(self.mgr._MQConnectionManager__getAllMessengersInfo()), sorted(expectedOutput)
        )
...
class TestMQConnectionStorageFunctions_removeMessenger(TestMQConnectionManager):
    ...
    def test_failure3(self):
        ...
        self.assertFalse(
            self.mgr._MQConnectionManager__removeMessenger("nonexisting", "/queue/test103", "producer1")
        )
...
if __name__ == "__main__":
    ...
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(TestMQConnectionManager_removeAllConnections)
    )
    ...
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(TestMQConnectionStorageFunctions_connectionExists)
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(TestMQConnectionStorageFunctions_destinationExists)
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(TestMQConnectionStorageFunctions_messengerExists)
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(TestMQConnectionStorageFunctions_getConnection)
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(TestMQConnectionStorageFunctions_getAllConnections)
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(TestMQConnectionStorageFunctions_getConnector)
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(TestMQConnectionStorageFunctions_setConnector)
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(TestMQConnectionStorageFunctions_getDestinations)
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(TestMQConnectionStorageFunctions_getMessengersId)
    )
    suite.addTest(
    ...
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(TestMQConnectionStorageFunctions_addMessenger)
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(TestMQConnectionStorageFunctions_removeMessenger)
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
    ...
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(TestMQConnectionStorageFunctions_getAllMessengersId)
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
