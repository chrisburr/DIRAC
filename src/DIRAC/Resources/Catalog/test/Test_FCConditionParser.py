...
class TestLogicEvaluation(unittest.TestCase):
    ...
    def test_05_priority(self):
        ...
        res = self.fcp(
            "catalogName", "operationName", self.lfns, condition="Dummy=True & Dummy=False | Dummy=True"
        )
        ...
        res = self.fcp(
            "catalogName", "operationName", self.lfns, condition="Dummy=False | [Dummy=False & Dummy=True]"
        )
