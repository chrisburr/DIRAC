...
class TestProxyPlugin(unittest.TestCase):
    ...
    @mock.patch(
        "DIRAC.Resources.Catalog.ConditionPlugins.ProxyPlugin.getProxyInfo", side_effect=mock_getProxyInfo
    )
    ...
    @mock.patch(
        "DIRAC.Resources.Catalog.ConditionPlugins.ProxyPlugin.getProxyInfo", side_effect=mock_getNoProxyInfo
    )
