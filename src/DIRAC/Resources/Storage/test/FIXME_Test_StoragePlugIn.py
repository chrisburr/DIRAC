...
class DirectoryTestCase(StoragePlugInTestCase):
    def test_putRemoveDirectory(self):
        ...
        if putDirRes["Value"]["Successful"][remoteDir]["Files"]:
            ...
            self.assertEqual(
                putDirRes["Value"]["Successful"][remoteDir]["Size"], self.numberOfFiles * sizeOfLocalFile
            )
        ...
        if removeDirRes["Value"]["Successful"][remoteDir]["FilesRemoved"]:
            self.assertEqual(
                removeDirRes["Value"]["Successful"][remoteDir]["FilesRemoved"], self.numberOfFiles
            )
            self.assertEqual(
        ...
        self.assertTrue(
            type(removeDirRes["Value"]["Successful"][remoteDir]["SizeRemoved"]) in six.integer_types
        )
