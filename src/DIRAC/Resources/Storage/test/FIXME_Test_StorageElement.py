...
class DirectoryTestCases(StorageElementTestCase):
    ...
    def test_listDirectory(self):
        ...
        if removeDirRes["Value"]["Successful"][destDirectory]["FilesRemoved"]:
            self.assertEqual(
                removeDirRes["Value"]["Successful"][destDirectory]["FilesRemoved"], self.numberOfFiles
            )
            self.assertEqual(
    ...
    def test_getDirectoryMetadata(self):
        ...
        if putDirRes["Value"]["Successful"][destDirectory]["Files"]:
            ...
            self.assertTrue(
                type(putDirRes["Value"]["Successful"][destDirectory]["Files"]) in six.integer_types
            )
            self.assertTrue(
                type(putDirRes["Value"]["Successful"][destDirectory]["Size"]) in six.integer_types
            )
        # Perform the checks for the list dir operation
    ...
    def test_getDirectorySize(self):
        ...
        self.assertTrue(
            type(getDirSizeRes["Value"]["Successful"][destDirectory]["Files"]) in six.integer_types
        )
        self.assertTrue(
            type(getDirSizeRes["Value"]["Successful"][destDirectory]["Size"]) in six.integer_types
        )
        # Perform the checks for the remove directory operation
        self.assertTrue(removeDirRes["OK"])
        self.assertTrue(removeDirRes["Value"])
    ...
    def test_getDirectory(self):
        ...
        for _dir in dirDict:
            if putDirRes["Value"]["Successful"][_dir]["Files"]:
                ...
                self.assertEqual(
                    putDirRes["Value"]["Successful"][_dir]["Size"], self.numberOfFiles * sizeOfLocalFile
                )
        ...
        for _dir in dirDict:
            if getDirRes["Value"]["Successful"][_dir]["Files"]:
                ...
                self.assertEqual(
                    getDirRes["Value"]["Successful"][_dir]["Size"], self.numberOfFiles * sizeOfLocalFile
                )
