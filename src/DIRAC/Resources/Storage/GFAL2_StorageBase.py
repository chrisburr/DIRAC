...
class GFAL2_StorageBase(StorageBase):
    ...
    def _getSingleDirectorySize(self, path):
        ...
        self.log.debug(
            "GFAL2_StorageBase._getSingleDirectorySize: Attempting to get the size of directory %s" % path
        )
    ...
    def _getSingleDirectoryMetadata(self, path):
        ...
        """
        self.log.debug(
            "GFAL2_StorageBase._getSingleDirectoryMetadata: Fetching metadata of directory %s." % path
        )
