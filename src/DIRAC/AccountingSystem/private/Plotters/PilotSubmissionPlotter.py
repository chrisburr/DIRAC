...
class PilotSubmissionPlotter(BaseReporter):
    ...
    def _reportSubmission(self, reportRequest):
        ...
        return S_OK(
            {"data": baseDataDict, "graphDataDict": graphDataDict, "granularity": granularity, "unit": unit}
        )
    ...
    def _reportSubmissionEfficiency(self, reportRequest):
        ...
        selectFields = (
            ...
            reportRequest["groupingFields"][1] + ["startTime", "bucketLength", "NumTotal", "NumSucceeded"],
        )
