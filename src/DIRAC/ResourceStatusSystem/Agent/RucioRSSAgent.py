        ...
        try:
            for rse in client.list_rses():
                ...
                if resStatus["OK"]:
                    ...
                    availabilityRead = (
                        True if seAccessValue["ReadAccess"] in ["Active", "Degraded"] else False
                    )
                    availabilityWrite = (
                        True if seAccessValue["WriteAccess"] in ["Active", "Degraded"] else False
                    )
                    availabilityDelete = (
                        True if seAccessValue["RemoveAccess"] in ["Active", "Degraded"] else False
                    )
                    isUpdated = False
