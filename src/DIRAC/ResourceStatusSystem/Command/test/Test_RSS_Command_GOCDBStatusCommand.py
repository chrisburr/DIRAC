...
def test_doCache(mocker):
    ...
    mocker.patch(
        "DIRAC.ResourceStatusSystem.Command.DowntimeCommand.getSEHosts",
...
def test_doMaster(mocker):
    ...
    mocker.patch(
        "DIRAC.ResourceStatusSystem.Command.DowntimeCommand.getStorageElementsHosts", return_value=S_OK()
    )
