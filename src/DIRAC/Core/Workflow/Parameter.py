...
class Parameter(object):
    ...
    def copy(self, parameter):
        if isinstance(parameter, Parameter):
            ...
            raise TypeError(
                "Can not make a copy of object " + str(type(self)) + " from the " + str(type(parameter))
            )
...
class ParameterCollection(list):
    ...
    def unlink(self, opt):
        ...
        if isinstance(opt, ParameterCollection):
            ...
            raise TypeError(
                "Can not unlink object type " + str(type(opt)) + " to the " + str(type(self)) + "."
            )
        ...
        for v in self:
            ...
            while True:
                ...
                if recurrency > recurrency_max:
                    ...
                    print(
                        "ERROR! reached maximum recurrency level", recurrency, "within the parameter ", str(v)
                    )
