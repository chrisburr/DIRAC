...
module2.addParameter(
    Parameter("CONFIG_NAME", "", "string", "self", "CONFIG_NAME", True, False, "Configuration Name")
)
module2.addParameter(
...
module2.addParameter(
    Parameter("appVersion", "", "string", "self", "appVersion", True, False, "Application Version")
)
module2.addParameter(
    Parameter("appType", "", "string", "self", "appType", True, False, "Application Version")
)
...
module2.addParameter(
    Parameter("inputDataType", "", "string", "self", "inputDataType", True, False, "Input Data Type")
)
module2.addParameter(
    Parameter(
        "NUMBER_OF_EVENTS",
...
module2.addParameter(
    Parameter("optionsFile", "", "string", "self", "optionsFile", True, False, "Options File")
)
module2.addParameter(
    Parameter("optionsLine", "", "string", "self", "optionsLine", True, False, "Number of Event", "option")
)
module2.addParameter(
    Parameter("systemConfig", "", "string", "self", "systemConfig", True, False, "Job Platform")
)
module2.addParameter(
    Parameter("poolXMLCatName", "", "string", "self", "poolXMLCatName", True, False, "POOL XML slice")
)
...
module3.addParameter(
    Parameter("NUMBER_OF_EVENTS_INPUT", "", "string", "", "", True, True, "number of events as input")
)
module3.addParameter(
...
module4.addParameter(
    Parameter("listoutput", [], "list", "self", "listoutput", True, False, "list of output data")
)
...
module6.addParameter(
    Parameter("listoutput_1", [], "list", "self", "listoutput_1", True, False, "list of output data")
)
module6.addParameter(
    Parameter("listoutput_2", [], "list", "self", "listoutput_2", True, False, "list of output data")
)
module6.addParameter(
    Parameter("listoutput_3", [], "list", "self", "listoutput_3", True, False, "list of output data")
)
module6.addParameter(
    Parameter("listoutput_4", [], "list", "self", "listoutput_4", True, False, "list of output data")
)
module6.addParameter(
    Parameter("listoutput_5", [], "list", "self", "listoutput_5", True, False, "list of output data")
)
module6.addParameter(
    Parameter("listoutput_6", [], "list", "self", "listoutput_6", True, False, "list of output data")
)
...
step1.addParameter(
    Parameter(
        "STEP_ID", "@{PRODUCTION_ID}_@{JOB_ID}_@{STEP_NUMBER}", "string", "", "", True, False, "Temporary fix"
    )
)
...
opt_brunel = (
    opt_brunel + ";DstWriter.Output = \"DATAFILE='PFN:@{outputData}' TYP='POOL_ROOTTREE' OPT='RECREATE'\""
)
opt_brunel = (
    opt_brunel
...
stepInstance3.unlink(
    ["listoutput_1", "listoutput_2", "listoutput_3", "listoutput_4", "listoutput_5", "listoutput_6"]
)
...
workflow1.addParameter(
    Parameter("CONFIG_VERSION", "CCRC08", "string", "", "", True, False, "Configuration Version")
)
