...
module2.addParameter(
    Parameter("outputData", "", "string", "self", "outputData", True, False, "list of output data")
)
...
module3.addParameter(
    Parameter("outputDataSE", "", "string", "self", "outputDataSE", True, False, "SE of output data")
)
...
workflow1.addParameter(
    Parameter("SoftwarePackages", "Brunel.v32r3p1", "JDL", "", "", True, False, "software")
)
