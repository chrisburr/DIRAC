...
class RequestHandler(object):
    ...
    def _rh_executeConnectionCallback(self, methodName, args=False):
        ...
        try:
            ...
            gLogger.exception(
                "Uncaught exception when serving Connect", "Function %s" % realMethod, lException=e
            )
    ...
    def __logRemoteQuery(self, method, args):
        ...
        gLogger.notice(
            "Executing action", "%s %s(%s)" % (self.srv_getFormattedRemoteCredentials(), method, argsString)
        )
