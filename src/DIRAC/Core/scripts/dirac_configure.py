...
def main():
    ...
    Script.registerSwitch(
        "C:", "ConfigurationServer=", "Set <server> as DIRAC configuration server", setServer
    )
    ...
    Script.registerSwitch(
        "M", "SkipVOMSDownload", "Configure to skip download of VOMS info", setSkipVOMSDownload
    )
