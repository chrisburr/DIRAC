...
class MatcherHandler(RequestHandler):
    ...
    def initializeHandler(cls, serviceInfoDict):
        ...
        gMonitor.registerActivity(
            "numTQs", "Number of Task Queues", "Matching", "tqsk queues", gMonitor.OP_MEAN, 300
        )
    ...
    def export_getMatchingTaskQueues(cls, resourceDict):
        ...
        matcher = Matcher(
            pilotAgentsDB=cls.pilotAgentsDB, jobDB=cls.jobDB, tqDB=cls.taskQueueDB, jlDB=cls.jobLoggingDB
        )
