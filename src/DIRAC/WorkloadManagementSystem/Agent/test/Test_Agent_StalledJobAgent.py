...
def sja(mocker):
    ...
    mocker.patch(
        "DIRAC.WorkloadManagementSystem.Agent.StalledJobAgent.JobLoggingDB.__init__", side_effect=mockNone
    )
    mocker.patch(
        "DIRAC.WorkloadManagementSystem.Agent.StalledJobAgent.getSystemInstance", side_effect=mockNone
    )
