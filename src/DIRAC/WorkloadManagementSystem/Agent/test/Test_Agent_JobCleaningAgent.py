...
def jca(mocker):
    ...
    mocker.patch(
        "DIRAC.WorkloadManagementSystem.Agent.JobCleaningAgent.AgentModule.am_getOption", return_value=mockAM
    )
    mocker.patch(
    ...
    mocker.patch(
        "DIRAC.WorkloadManagementSystem.Agent.JobCleaningAgent.JobDB.selectJobs", side_effect=mockReply
    )
    ...
    mocker.patch(
        "DIRAC.WorkloadManagementSystem.Agent.JobCleaningAgent.JobMonitoringClient", return_value=mockJMC
    )
    ...
    [
        ...
        (
            [],
            {
                "OK": True,
                "Value": {
                    1: {"OutputSandboxLFN": "/some/lfn/1.txt"},
                    2: {"OutputSandboxLFN": "/some/other/lfn/2.txt"},
                },
            },
            {
                "OK": True,
                "Value": {"Failed": {}, "Successful": {1: "/some/lfn/1.txt", 2: "/some/other/lfn/2.txt"}},
            },
        ),
        (
            ["a", "b"],
