...
from DIRAC.MonitoringSystem.private.Plotters.BasePlotter import (
    BasePlotter as myBasePlotter,
)
...
class PlottersList(object):
    ...
    def __init__(self):
        ...
        objectsLoaded = loadObjects(
            "MonitoringSystem/private/Plotters",
...
class MainReporter(object):
    ...
    def __calculateReportHash(self, reportRequest):
        ...
        granularity = gConfig.getValue(
            "%s/CacheTimeGranularity" % self.__csSection, 300
        )
    ...
    def generate(self, reportRequest, credDict):
        ...
        plotter = plotterClass["Value"](
            self.__db, self.__setup, reportRequest["extraArgs"]
        )
