...
class BasePlotter(DBUtils):
    ...
    def __retrieveReportData(self, reportRequest, reportHash):
        ...
        return gDataCache.getReportData(
            reportRequest=reportRequest, reportHash=reportHash, dataFunc=funcObj
        )
    ...
    def _getTimedData(
        self, startTime, endTime, selectField, preCondDict, metadataDict=None
    ):
        """
    ...
    def __plotData(self, filename, dataDict, metadata, funcToPlot):
        ...
        finalResult = funcToPlot(
            fileName=plotFileName, data=dataDict, metadata=metadata
        )
