...
class ComponentMonitoringPlotter(BasePlotter):
    ...
    def __reportAllResources(self, reportRequest, metric, unit):
        ...
        try:
            _, _, _, unitName = self._findSuitableUnit(
                dataDict, self._getAccumulationMaxValue(dataDict), unit
            )
    ...
    def __plotAllResources(self, reportRequest, plotInfo, filename, title):
        ...
        return self._generateStackedLinePlot(
            filename=filename, dataDict=plotInfo["data"], metadata=metadata
        )
    ...
    def _plotRunningThreads(self, reportRequest, plotInfo, filename):
        ...
        return self.__plotAllResources(
            reportRequest, plotInfo, filename, "Number of running threads"
        )
    ...
    def _plotMemoryUsage(self, reportRequest, plotInfo, filename):
        ...
        """
        return self.__plotAllResources(
            reportRequest, plotInfo, filename, "Memory usage"
        )
    ...
    def _plotRunningTime(self, reportRequest, plotInfo, filename):
        ...
        """
        return self.__plotAllResources(
            reportRequest, plotInfo, filename, "Running time"
        )
