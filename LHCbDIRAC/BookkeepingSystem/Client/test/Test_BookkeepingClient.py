...
@pytest.mark.parametrize("mockTCResponse, mockPRResponse, expected, expectedRes", [
    ...
    ({'OK': True, 'Value': {}}, {}, False, None),
    ({'OK': True, 'Value': {'RequestID': 1}}, {'OK': False, 'Message': 'bif'}, False, None),
    ({'OK': True, 'Value': {'RequestID': 1}}, {'OK': True, 'Value': [1]}, True, []),
    ({'OK': True, 'Value': {'RequestID': 1}}, {'OK': True, 'Value': [2, 1]}, True, [2]),
    ({'OK': True, 'Value': {'RequestID': 1}}, {'OK': True, 'Value': [3, 2, 1]}, True, [2, 3]),
    ({'OK': True, 'Value': {'RequestID': 1}}, {'OK': True, 'Value': [3, 1, 2]}, True, [3]),
    ({'OK': True, 'Value': {'RequestID': 1}}, {'OK': True, 'Value': [4, 3, 1, 2]}, True, [3, 4]),
])
