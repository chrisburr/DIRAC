...
INSERT INTO DATAQUALITY (QUALITYID,DATAQUALITYFLAG) SELECT 6,'TEST_DB_TAGS' FROM DUAL WHERE NOT EXISTS (SELECT * FROM DATAQUALITY WHERE (QUALITYID=6 AND DATAQUALITYFLAG='TEST_DB_TAGS'));
...
INSERT INTO DATAQUALITY (QUALITYID,DATAQUALITYFLAG) SELECT 4,'MAYBE' FROM DUAL WHERE NOT EXISTS (SELECT * FROM DATAQUALITY WHERE (QUALITYID=4 AND DATAQUALITYFLAG='MAYBE'));
INSERT INTO DATAQUALITY (QUALITYID,DATAQUALITYFLAG) SELECT 5,'EXPRESS_OK' FROM DUAL WHERE NOT EXISTS (SELECT * FROM DATAQUALITY WHERE (QUALITYID=5 AND DATAQUALITYFLAG='EXPRESS_OK'));
COMMIT;
