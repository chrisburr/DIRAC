...
def test_xmltojsonCat2():
  lCategory2 = [
        {'@name': 'TTHitMonitor/DeltaRay', '#text': '10184'},
...
def test_xmltojsonCat3():
  lCategory3 = [
      {'@name': 'CheckPuVetoHits/Diff.    - Displacement x',
       '#text': '0'},
  ...
  dictCategory3 = {'CheckPuVetoHits/Diff.': {
...
def test_difisnotnull():
  dictCategory3NotNull = {'CheckPuVetoHits/Diff.': {
      'Displacement': {'x': 0, 'y': 0, 'z': 0},
      'Energy': 0,
      'Entry Point': {'x': 0, 'y': 0, 'z': 0},
      'Parent |P|': 3,
  ...
  dictCategory3Null = {'CheckRichOpPhot/Diff.': {
