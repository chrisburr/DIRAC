...
def test_xmltojsonCat3():
  lCategory3 = [{'@name': 'CheckPuVetoHits/Diff.    - Displacement x', '#text': '0'}, {'@name': 'CheckPuVetoHits/Diff.    - Displacement y', '#text': '0'}, {'@name': 'CheckPuVetoHits/Diff.    - Displacement z', '#text': '0'}, {'@name': 'CheckPuVetoHits/Diff.    - Energy', '#text': '0'}, {'@name': 'CheckPuVetoHits/Diff.    - Entry Point x', '#text': '0'}, {'@name': 'CheckPuVetoHits/Diff.    - Entry Point y', '#text': '0'}, {'@name': 'CheckPuVetoHits/Diff.    - Entry Point z', '#text': '0'}, {'@name': 'CheckPuVetoHits/Diff.    - Parent |P|', '#text': '3'}, {'@name': 'CheckPuVetoHits/Diff.    - TOF', '#text': '0'}]  # noqa
