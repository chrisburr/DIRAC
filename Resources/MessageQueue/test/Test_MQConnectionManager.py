...
class TestMQConnectionManager(unittest.TestCase):
    def setUp(self):
        self.maxDiff = (
            None  # To show full difference between structures in  case of error
        )
        dest = {}
        dest.update(
...
class TestMQConnectionStorageFunctions_connectionExists(TestMQConnectionManager):
    def test_success(self):
        self.assertTrue(
            self.mgr._MQConnectionManager__connectionExists("mardirac3.in2p3.fr")
        )
...
class TestMQConnectionStorageFunctions_destinationExists(TestMQConnectionManager):
    def test_success(self):
        self.assertTrue(
            self.mgr._MQConnectionManager__destinationExists(
                "mardirac3.in2p3.fr", "/queue/test1"
            )
        )
...
class TestMQConnectionStorageFunctions_messengerExists(TestMQConnectionManager):
    def test_success(self):
        self.assertTrue(
            self.mgr._MQConnectionManager__messengerExists(
    ...
    def test_failure(self):
        self.assertFalse(
            self.mgr._MQConnectionManager__messengerExists(
                "noexisting", "/queue/test1", "producer4"
            )
        )
    ...
    def test_failure3(self):
        self.assertFalse(
            self.mgr._MQConnectionManager__messengerExists(
                "mardirac3.in2p3.fr", "/queue/test1", "producer10"
            )
        )
...
class TestMQConnectionStorageFunctions_getConnection(TestMQConnectionManager):
    def test_success(self):
        ...
        self.assertEqual(
            self.mgr._MQConnectionManager__getConnection("testdir.blabla.ch"),
            expectedConn,
        )
...
class TestMQConnectionStorageFunctions_getAllConnections(TestMQConnectionManager):
    def test_success(self):
        ...
        self.assertEqual(
            sorted(self.mgr._MQConnectionManager__getAllConnections()),
...
class TestMQConnectionStorageFunctions_getConnector(TestMQConnectionManager):
    def test_success(self):
        self.assertEqual(
            self.mgr._MQConnectionManager__getConnector("testdir.blabla.ch"),
            "TestConnector2",
        )
...
class TestMQConnectionStorageFunctions_setConnector(TestMQConnectionManager):
    def test_success(self):
        self.assertTrue(
            self.mgr._MQConnectionManager__setConnector(
                "testdir.blabla.ch", "TestConnector5"
            )
        )
        self.assertEqual(
            self.mgr._MQConnectionManager__getConnector("testdir.blabla.ch"),
...
class TestMQConnectionStorageFunctions_getDestinations(TestMQConnectionManager):
    def test_success(self):
        ...
        self.assertEqual(
            self.mgr._MQConnectionManager__getDestinations("mardirac3.in2p3.fr"),
            expectedDests,
        )

    def test_failure(self):
        self.assertEqual(
            self.mgr._MQConnectionManager__getDestinations("nonexisiting"), {}
        )
...
class TestMQConnectionStorageFunctions_getMessengersId(TestMQConnectionManager):
    ...
    def test_success2(self):
        ...
        self.assertEqual(
            self.mgr._MQConnectionManager__getMessengersId(
                "mardirac3.in2p3.fr", "/queue/test2"
            ),
            expectedMess2,
        )
    ...
    def test_failure2(self):
        self.assertEqual(
            self.mgr._MQConnectionManager__getMessengersId(
                "mardirac3.in2p3.fr", "nonexisiting"
            ),
            [],
        )
...
class TestMQConnectionStorageFunctions_getMessengersIdWithType(TestMQConnectionManager):
    def test_success(self):
        ...
        self.assertEqual(
            self.mgr._MQConnectionManager__getMessengersIdWithType(
                "mardirac3.in2p3.fr", "/queue/test1", "producer"
            ),
            expectedMess,
        )
    ...
    def test_success2(self):
        ...
        self.assertEqual(
            self.mgr._MQConnectionManager__getMessengersIdWithType(
                "mardirac3.in2p3.fr", "/queue/test2", "producer"
            ),
            expectedMess2,
        )
    ...
    def test_success3(self):
        ...
        self.assertEqual(
            self.mgr._MQConnectionManager__getMessengersIdWithType(
                "mardirac3.in2p3.fr", "/queue/test1", "consumer"
            ),
            expectedMess,
        )
    ...
    def test_success4(self):
        ...
        self.assertEqual(
            self.mgr._MQConnectionManager__getMessengersIdWithType(
                "mardirac3.in2p3.fr", "/queue/test2", "consumer"
            ),
            expectedMess2,
        )
    ...
    def test_failure2(self):
        self.assertEqual(
            self.mgr._MQConnectionManager__getMessengersIdWithType(
                "mardirac3.in2p3.fr", "nonexisiting", "producer"
            ),
            [],
        )
...
class TestMQConnectionStorageFunctions_getAllMessengersId(TestMQConnectionManager):
    def test_success(self):
        ...
        self.assertEqual(
            sorted(self.mgr._MQConnectionManager__getAllMessengersId()),
            sorted(expectedOutput),
        )


class TestMQConnectionStorageFunctions_getAllMessengersIdWithType(
...
class TestMQConnectionStorageFunctions_addMessenger(TestMQConnectionManager):
    def test_success(self):
        ...
        self.assertTrue(
            self.mgr._MQConnectionManager__addMessenger(
                "mardirac3.in2p3.fr", "/queue/test1", "producer1"
            )
        )
        self.assertEqual(
...
class TestMQConnectionStorageFunctions_removeMessenger(TestMQConnectionManager):
    ...
    def test_failure(self):
        ...
        self.assertFalse(
            self.mgr._MQConnectionManager__removeMessenger(
                "testdir.blabla.ch", "/queue/test3", "producer10"
            )
        )
    ...
    def test_failure2(self):
        ...
        self.assertFalse(
            self.mgr._MQConnectionManager__removeMessenger(
                "testdir.blabla.ch", "/queue/nonexisting", "producer1"
            )
        )
    ...
    def test_failure3(self):
        ...
        self.assertFalse(
            self.mgr._MQConnectionManager__removeMessenger(
                "nonexisting", "/queue/test103", "producer1"
            )
        )
...
class TestMQConnectionManager_addNewmessenger(TestMQConnectionManager):
    def test_success(self):
        result = self.mgr.addNewMessenger(
            mqURI="mardirac3.in2p3.fr::Queues::test1", messengerType="producer"
        )
    ...
    def test_success2(self):
        result = self.mgr.addNewMessenger(
            mqURI="mardirac3.in2p3.fr::Topics::test1", messengerType="consumer"
        )
        self.assertTrue(result["OK"])
    ...
    def test_success3(self):
        result = self.mgr.addNewMessenger(
            mqURI="testdir.blabla.ch::Queues::test3", messengerType="consumer"
        )
        self.assertTrue(result["OK"])
        self.assertEqual(result["Value"], "consumer5")
    ...
    def test_success4(self):
        ...
        result = self.mgr.addNewMessenger(
            mqURI="noexisting.blabla.ch::Queues::test3", messengerType="consumer"
        )
        self.assertTrue(result["OK"])
        self.assertEqual(result["Value"], "consumer5")
        expectedOutput = [
...
class TestMQConnectionManager_startConnection(TestMQConnectionManager):
    def test_success(self):
        ...
        result = self.mgr.startConnection(
            mqURI="mardirac3.in2p3.fr::Queues::test1",
            params={},
            messengerType="producer",
        )
        self.assertTrue(result["OK"])
        self.assertEqual(result["Value"], "producer5")
        expectedOutput = [
    ...
    @mock.patch(
        "DIRAC.Resources.MessageQueue.MQConnectionManager.MQConnectionManager.createConnectorAndConnect"
    )
    def test_success2(self, mock_createConnectorAndConnect):
        # connection does not exist
        mock_createConnectorAndConnect.return_value = S_OK("MyConnector")
        result = self.mgr.startConnection(
            mqURI="noexisting.blabla.ch::Queues::test3",
            params={},
            messengerType="consumer",
        )
        self.assertTrue(result["OK"])
        self.assertEqual(result["Value"], "consumer5")
        expectedOutput = [
...
class TestMQConnectionManager_stopConnection(TestMQConnectionManager):
    def test_success(self):
        result = self.mgr.stopConnection(
            mqURI="mardirac3.in2p3.fr::Queues::test1", messengerId="producer4"
        )
        self.assertTrue(result["OK"])
        expectedOutput = [
            "mardirac3.in2p3.fr/queue/test1/consumer1",
    ...
    def test_success2(self):
        result = self.mgr.stopConnection(
            mqURI="mardirac3.in2p3.fr::Topics::test1", messengerId="producer1"
        )
        self.assertTrue(result["OK"])
        expectedOutput = [
            "mardirac3.in2p3.fr/queue/test1/producer4",
    ...
    @mock.patch(
        "DIRAC.Resources.MessageQueue.MQConnectionManager.MQConnectionManager.unsubscribe"
    )
    @mock.patch(
        "DIRAC.Resources.MessageQueue.MQConnectionManager.MQConnectionManager.disconnect"
    )
    def test_success3(self, mock_disconnect, mock_unsubscribe):
        ...
        result = self.mgr.stopConnection(
            mqURI="testdir.blabla.ch::Queues::test3", messengerId="consumer3"
        )
        self.assertTrue(result["OK"])
        result = self.mgr.stopConnection(
            mqURI="testdir.blabla.ch::Queues::test3", messengerId="producer1"
        )
        self.assertTrue(result["OK"])
        result = self.mgr.stopConnection(
            mqURI="testdir.blabla.ch::Queues::test3", messengerId="consumer2"
        )
        self.assertTrue(result["OK"])
        result = self.mgr.stopConnection(
            mqURI="testdir.blabla.ch::Queues::test3", messengerId="consumer4"
        )
        self.assertTrue(result["OK"])
        expectedOutput = [
            "mardirac3.in2p3.fr/queue/test1/producer4",
...
if __name__ == "__main__":
    ...
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
            TestMQConnectionManager_addNewmessenger
        )
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
            TestMQConnectionManager_startConnection
        )
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
            TestMQConnectionManager_stopConnection
        )
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
            TestMQConnectionManager_removeAllConnections
        )
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
            TestMQConnectionManager_getAllMessengers
        )
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
            TestMQConnectionManager_getConnector
        )
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
            TestMQConnectionStorageFunctions_connectionExists
        )
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
            TestMQConnectionStorageFunctions_destinationExists
        )
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
            TestMQConnectionStorageFunctions_messengerExists
        )
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
            TestMQConnectionStorageFunctions_getConnection
        )
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
            TestMQConnectionStorageFunctions_getAllConnections
        )
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
            TestMQConnectionStorageFunctions_getConnector
        )
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
            TestMQConnectionStorageFunctions_setConnector
        )
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
            TestMQConnectionStorageFunctions_getDestinations
        )
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
            TestMQConnectionStorageFunctions_getMessengersId
        )
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
    ...
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
            TestMQConnectionStorageFunctions_addMessenger
        )
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
            TestMQConnectionStorageFunctions_removeMessenger
        )
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
            TestMQConnectionStorageFunctions_getAllMessengersInfo
        )
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
            TestMQConnectionStorageFunctions_getAllMessengersId
        )
    )
    suite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(
