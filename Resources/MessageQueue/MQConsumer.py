...
from DIRAC.Resources.MessageQueue.Utilities import (
    getDestinationAddress,
    getMQService,
    generateDefaultCallback,
)
...
class MQConsumer(object):
    def __init__(
        self, mqManager, mqURI, consumerId, callback=generateDefaultCallback()
    ):
    ...
    def close(self):
        ...
        """
        return self._connectionManager.stopConnection(
            mqURI=self._mqURI, messengerId=self._id
        )
