...
class DirectoryTestCase(StoragePlugInTestCase):
    def test_putRemoveDirectory(self):
        ...
        if putDirRes["Value"]["Successful"][remoteDir]["Files"]:
            self.assertEqual(
                putDirRes["Value"]["Successful"][remoteDir]["Files"], self.numberOfFiles
            )
            self.assertEqual(
        ...
        self.assertTrue(
            isinstance(putDirRes["Value"]["Successful"][remoteDir]["Files"], int)
        )
        self.assertTrue(
            type(putDirRes["Value"]["Successful"][remoteDir]["Size"])
        ...
        self.assertTrue(
            isinstance(
                removeDirRes["Value"]["Successful"][remoteDir]["FilesRemoved"], int
            )
        )
        self.assertTrue(
...
class FileTestCase(StoragePlugInTestCase):
    ...
    def test_putGetFileMetaData(self):
        ...
        self.assertTrue(
            expectedError in directoryMetadataRes["Value"]["Failed"][remoteDir]
        )
    ...
    def test_putPinRelease(self):
        ...
        self.assertTrue(
            type(pinFileRes["Value"]["Successful"][remoteFile]) in six.string_types
        )
    ...
    def test_putPrestageStatus(self):
        ...
        self.assertTrue(prestageRes["Value"]["Successful"][remoteFile])
        self.assertTrue(
            type(prestageRes["Value"]["Successful"][remoteFile]) in six.string_types
        )
