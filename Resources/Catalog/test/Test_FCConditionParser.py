...
class TestLogicEvaluation(unittest.TestCase):
    ...
    def test_01_simpleParse(self):
        ...
        res = self.fcp(
            "catalogName", "operationName", self.lfns, condition="Dummy=True"
        )
        ...
        res = self.fcp(
            "catalogName", "operationName", self.lfns, condition="Dummy=False"
        )
    ...
    def test_03_andLogic(self):
        ...
        res = self.fcp(
            ...
            "operationName",
            self.lfns,
            condition="Dummy=True & Dummy=True",
        )
        ...
        res = self.fcp(
            ...
            "operationName",
            self.lfns,
            condition="Dummy=False & Dummy=True",
        )
        ...
        res = self.fcp(
            ...
            "operationName",
            self.lfns,
            condition="Dummy=True & Dummy=False",
        )
    ...
    def test_04_orLogic(self):
        ...
        res = self.fcp(
            ...
            "operationName",
            self.lfns,
            condition="Dummy=False | Dummy=False",
        )
    ...
    def test_06_errors(self):
        ...
        # Error in the plugin
        res = self.fcp(
            "catalogName", "operationName", self.lfns, condition="Dummy=CantParse"
        )
        ...
        res = self.fcp(
            ...
            "operationName",
            self.lfns,
            condition="NonExistingPlugin=something",
        )
