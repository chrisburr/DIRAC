...
class TestInitialization(unittest.TestCase):
    ...
    def test_01_init(self, mk_getSelectedCatalogs, mk_getEligibleCatalogs):
        ...
        twoMastersFc = FileCatalog(
            catalogs=["c1_True_True_True_5_2_2_0", "c2_True_True_True_5_2_2_0"]
        )
        self.assertTrue(not twoMastersFc.isOK())

        # One master should be ok
        oneMasterFc = FileCatalog(
            catalogs=["c1_True_True_True_2_0_2_2", "c2_False_True_True_3_1_4_2"]
        )
        ...
        self.assertEqual(
            sorted(oneMasterFc.no_lfn_methods),
            sorted(readList(1, reverse=3) + writeList(4)),
        )

        # No master should be ok
        noMasterFc = FileCatalog(
            catalogs=["c1_False_True_True_2_0_2_0", "c2_False_True_True_3_0_4_0"]
        )
        self.assertTrue(oneMasterFc.isOK())
...
class TestWrite(unittest.TestCase):
    ...
    def test_01_Normal(self, mk_getSelectedCatalogs, mk_getEligibleCatalogs):
        ...
        fc = FileCatalog(
            catalogs=["c1_True_True_True_2_0_2_0", "c2_False_True_True_3_0_1_0"]
        )
        ...
        self.assertEqual(
            sorted(["c1", "c2"]), sorted(res["Value"]["Successful"][lfn].keys())
        )
    ...
    def test_02_condParser(self, mk_getSelectedCatalogs, mk_getEligibleCatalogs):
        ...
        fc = FileCatalog(
            catalogs=[
                "c1_True_True_True_2_0_2_0",
                "c2_False_True_True_3_0_1_0",
        ...
        self.assertEqual(
            sorted(res["Value"]["Successful"][lfn1]), sorted(["c1", "c2", "c3"])
        )
        self.assertEqual(
            sorted(res["Value"]["Successful"][lfn2]), sorted(["c1", "c2", "c3"])
        )
        self.assertTrue(not res["Value"]["Failed"])
    ...
    def test_03_noLFN(self, mk_getSelectedCatalogs, mk_getEligibleCatalogs):
        ...
        fc = FileCatalog(
            catalogs=["c1_True_True_True_2_0_2_1", "c2_False_True_True_3_0_2_1"]
        )
